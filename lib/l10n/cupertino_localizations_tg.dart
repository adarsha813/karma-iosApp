...
class CupertinoLocalizationsTg extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsTg();

  // TODO: Add translations for Tajik
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsTgDelegate();
}

class _CupertinoLocalizationsTgDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsTg();
  }

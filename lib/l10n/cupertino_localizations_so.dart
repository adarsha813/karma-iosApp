...
class CupertinoLocalizationsSo extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsSo();

  // TODO: Add translations for Somali
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsSoDelegate();
}

class _CupertinoLocalizationsSoDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsSoDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsSo();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsSoDelegate old) => false;
}

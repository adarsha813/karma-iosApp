...
class CupertinoLocalizationsCeb extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsCeb();

  // TODO: Add translations for Cebuano
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsCebDelegate();
}

class _CupertinoLocalizationsCebDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsCebDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsCeb();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsCebDelegate old) => false;
}

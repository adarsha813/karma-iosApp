...
class MaterialLocalizationsGu extends DefaultMaterialLocalizations {
  MaterialLocalizationsGu();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsGuDelegate();
}

class _MaterialLocalizationsGuDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsGuDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsGu();
  }

  @override
  bool shouldReload(_MaterialLocalizationsGuDelegate old) => false;
}

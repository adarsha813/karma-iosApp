...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String get aboutCompanyDescription =>
      '저희는 사용자에게 최고의 점성술 경험을 제공하기 위해 최선을 다하고 있습니다.';
  ...
  String get missionDescription =>
      '사용자가 삶에서 정보에 입각한 결정을 내릴 수 있도록 정확하고 개인화된 점성술 통찰력을 제공합니다.';

  @override
  String get ourVision => '우리의 비전';

  @override
  String get visionDescription => '기술과 고대의 지혜를 결합하여 가장 신뢰받는 점성술 플랫폼이 되는 것입니다.';

  @override
  String get ourValues => '우리의 가치';

  @override
  String get valuesDescription => '정직성, 정확성, 사용자 중심 디자인, 지속적인 혁신.';

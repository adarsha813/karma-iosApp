...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      '점성술은 천체의 움직임과 그것이 인간 삶에 미치는 영향을 연구하는 고대 학문으로, 성격, 관계, 삶의 사건에 대한 통찰력을 제공합니다.';
  ...
  String get onboardingWhyUseAppDesc =>
      '사람이 직접 생성한 정확한 운세와 출생 차트에 맞는 맞춤 안내를 받아보세요. 숙련된 점성가의 일일 예측과 맞춤형 조언을 통해 현명한 결정을 내리세요.';
  ...
  String get onboardingHowToUseDesc =>
      '생년월일, 정확한 시간, 출생지, 그리고 기타 관련 정보를 입력하시면 바로 시작하실 수 있습니다. 일일 운세를 살펴보고, 전문 점성가에게 질문하고, 프로필을 관리하여 정확하고 개인화된 예측을 받아보세요. 로그인은 필요하지 않습니다.';

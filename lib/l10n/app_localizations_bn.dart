...
class AppLocalizationsBn extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'জ্যোতিষশাস্ত্র হল স্বর্গীয় গতিবিধি এবং মানব জীবনের উপর তাদের প্রভাবের প্রাচীন অধ্যয়ন, যা ব্যক্তিত্ব, সম্পর্ক এবং জীবনের ঘটনাবলী সম্পর্কে অন্তর্দৃষ্টি প্রদান করে।';
  ...
  String get onboardingWhyUseAppDesc =>
      'আপনার জন্ম তালিকা অনুসারে সঠিক, মানব-সৃষ্ট রাশিফল এবং নির্দেশিকা পান। অভিজ্ঞ জ্যোতিষীদের কাছ থেকে প্রতিদিনের ভবিষ্যদ্বাণী এবং ব্যক্তিগতকৃত পরামর্শের মাধ্যমে সুচিন্তিত সিদ্ধান্ত নিন।';
  ...
  String get onboardingHowToUseDesc =>
      'তাৎক্ষণিকভাবে শুরু করার জন্য কেবল আপনার জন্ম তারিখ, সঠিক সময়, জন্মস্থান এবং অন্যান্য প্রাসঙ্গিক বিবরণ লিখুন। দৈনিক রাশিফলগুলি অন্বেষণ করুন, বিশেষজ্ঞ জ্যোতিষীদের কাছে প্রশ্ন জিজ্ঞাসা করুন এবং সুনির্দিষ্ট, ব্যক্তিগতকৃত ভবিষ্যদ্বাণীগুলির জন্য আপনার প্রোফাইল পরিচালনা করুন - কোনও লগইন প্রয়োজন নেই।';

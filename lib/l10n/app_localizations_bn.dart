...
class AppLocalizationsBn extends AppLocalizations {
  ...
  String get aboutCompanyDescription =>
      'আমরা আমাদের ব্যবহারকারীদের সেরা জ্যোতিষশাস্ত্র অভিজ্ঞতা প্রদানের জন্য প্রতিশ্রুতিবদ্ধ।';
  ...
  String get missionDescription =>
      'ব্যবহারকারীদের তাদের জীবনে সুচিন্তিত সিদ্ধান্ত নিতে সাহায্য করার জন্য সঠিক এবং ব্যক্তিগতকৃত জ্যোতিষশাস্ত্রের অন্তর্দৃষ্টি প্রদান করা।';
  ...
  String get visionDescription =>
      'প্রযুক্তি এবং প্রাচীন জ্ঞানের সমন্বয়ে সবচেয়ে বিশ্বস্ত জ্যোতিষশাস্ত্র প্ল্যাটফর্ম হয়ে ওঠা।';
  ...
  String get valuesDescription =>
      'সততা, নির্ভুলতা, ব্যবহারকারী-কেন্দ্রিক নকশা এবং ক্রমাগত উদ্ভাবন।';
  ...
  String get paymentRequiredMessage =>
      'তুমি তোমার বিনামূল্যের প্রশ্নগুলো ব্যবহার করেছ। চালিয়ে যেতে ₹৫০ প্রদান করো।';

...
class MaterialLocalizationsYi extends DefaultMaterialLocalizations {
  MaterialLocalizationsYi();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsYiDelegate();
}

class _MaterialLocalizationsYiDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsYiDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsYi();
  }

  @override
  bool shouldReload(_MaterialLocalizationsYiDelegate old) => false;
}

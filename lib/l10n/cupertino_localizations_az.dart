...
class CupertinoLocalizationsAz extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsAz();

  // TODO: Add translations for Azerbaijani
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsAzDelegate();
}

class _CupertinoLocalizationsAzDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsAzDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'az';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsAz();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsAzDelegate old) => false;
}

...
class CupertinoLocalizationsSn extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsSn();

  // TODO: Add translations for Shona
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsSnDelegate();
}

class _CupertinoLocalizationsSnDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsSnDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsSn();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsSnDelegate old) => false;
}

...
class CupertinoLocalizationsHaw extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsHaw();

  // TODO: Add translations for Hawaiian
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsHawDelegate();
}

class _CupertinoLocalizationsHawDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsHawDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'haw';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsHaw();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsHawDelegate old) => false;
}

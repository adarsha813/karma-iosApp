...
class CupertinoLocalizationsKy extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsKy();

  // TODO: Add translations for Kyrgyz
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsKyDelegate();
}

class _CupertinoLocalizationsKyDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsKyDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsKy();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsKyDelegate old) => false;
}

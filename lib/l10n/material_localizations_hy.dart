...
class MaterialLocalizationsHy extends DefaultMaterialLocalizations {
  MaterialLocalizationsHy();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsHyDelegate();
}

class _MaterialLocalizationsHyDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsHyDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsHy();
  }

  @override
  bool shouldReload(_MaterialLocalizationsHyDelegate old) => false;
}

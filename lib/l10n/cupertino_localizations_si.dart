...
class CupertinoLocalizationsSi extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsSi();

  // TODO: Add translations for Sinhala
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsSiDelegate();
}

class _CupertinoLocalizationsSiDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsSiDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsSi();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsSiDelegate old) => false;
}

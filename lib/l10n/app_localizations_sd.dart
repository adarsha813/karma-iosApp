...
class AppLocalizationsSd extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'علم نجوم آسماني جسمن جو مطالعو آهي...';
  ...
  String get onboardingWhyUseAppDesc =>
      'باخبر فيصلا ڪرڻ لاءِ ذاتي زائچا، روزاني اڳڪٿيون، ۽ هدايت حاصل ڪريو.';
  ...
  String get onboardingHowToUseDesc =>
      'آساني سان نيويگيٽ ڪريو، روزاني افقون چيڪ ڪريو، ۽ صحيح اڳڪٿين لاءِ پنهنجي پروفائل کي منظم ڪريو.';
  ...
  String get aboutCompanyDescription =>
      'اسان پنهنجي استعمال ڪندڙن کي بهترين نجومي تجربو پهچائڻ لاءِ پرعزم آهيون.';
  ...
  String get missionDescription =>
      'استعمال ڪندڙن کي پنهنجي زندگي ۾ باخبر فيصلا ڪرڻ ۾ مدد ڏيڻ لاءِ صحيح ۽ ذاتي علم نجوم جي بصيرت فراهم ڪرڻ لاءِ.';
  ...
  String get visionDescription =>
      'ٽيڪنالاجي ۽ قديم حڪمت کي گڏ ڪندي، سڀ کان وڌيڪ قابل اعتماد نجومي پليٽ فارم بڻجڻ لاءِ.';
  ...
  String get valuesDescription =>
      'سالميت، درستگي، استعمال ڪندڙ-مرڪزي ڊيزائن، ۽ مسلسل جدت.';

...
class CupertinoLocalizationsMt extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsMt();

  // TODO: Add translations for Maltese
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsMtDelegate();
}

class _CupertinoLocalizationsMtDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsMtDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'mt';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsMt();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsMtDelegate old) => false;
}

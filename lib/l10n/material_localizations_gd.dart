...
class MaterialLocalizationsGd extends DefaultMaterialLocalizations {
  MaterialLocalizationsGd();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsGdDelegate();
}

class _MaterialLocalizationsGdDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsGdDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsGd();
  }

  @override
  bool shouldReload(_MaterialLocalizationsGdDelegate old) => false;
}

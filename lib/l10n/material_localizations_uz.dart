...
class MaterialLocalizationsUz extends DefaultMaterialLocalizations {
  MaterialLocalizationsUz();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsUzDelegate();
}

class _MaterialLocalizationsUzDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsUzDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsUz();
  }

  @override
  bool shouldReload(_MaterialLocalizationsUzDelegate old) => false;
}

...
class CupertinoLocalizationsKk extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsKk();

  // TODO: Add translations for Kazakh
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsKkDelegate();
}

class _CupertinoLocalizationsKkDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsKkDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsKk();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsKkDelegate old) => false;
}

...
class CupertinoLocalizationsKa extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsKa();

  // TODO: Add translations for Georgian
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsKaDelegate();
}

class _CupertinoLocalizationsKaDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsKaDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'ka';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsKa();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsKaDelegate old) => false;
}

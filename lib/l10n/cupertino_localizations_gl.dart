...
class CupertinoLocalizationsGl extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsGl();

  // TODO: Add translations for Galician
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsGlDelegate();
}

class _CupertinoLocalizationsGlDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsGlDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'gl';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsGl();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsGlDelegate old) => false;
}

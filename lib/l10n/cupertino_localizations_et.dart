...
class CupertinoLocalizationsEt extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsEt();

  // TODO: Add translations for Estonian
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsEtDelegate();
}

class _CupertinoLocalizationsEtDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsEtDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsEt();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsEtDelegate old) => false;
}

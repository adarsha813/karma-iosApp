...
class CupertinoLocalizationsXh extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsXh();

  // TODO: Add translations for Xhosa
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsXhDelegate();
}

class _CupertinoLocalizationsXhDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsXhDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsXh();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsXhDelegate old) => false;
}

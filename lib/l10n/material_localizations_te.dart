...
class MaterialLocalizationsTe extends DefaultMaterialLocalizations {
  MaterialLocalizationsTe();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsTeDelegate();
}

class _MaterialLocalizationsTeDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsTeDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsTe();
  }

  @override
  bool shouldReload(_MaterialLocalizationsTeDelegate old) => false;
}

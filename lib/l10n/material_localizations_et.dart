...
class MaterialLocalizationsEt extends DefaultMaterialLocalizations {
  MaterialLocalizationsEt();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsEtDelegate();
}

class _MaterialLocalizationsEtDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsEtDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsEt();
  }

  @override
  bool shouldReload(_MaterialLocalizationsEtDelegate old) => false;
}

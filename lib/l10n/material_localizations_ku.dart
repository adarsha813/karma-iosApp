...
class MaterialLocalizationsKu extends DefaultMaterialLocalizations {
  MaterialLocalizationsKu();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsKuDelegate();
}

class _MaterialLocalizationsKuDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsKuDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsKu();
  }

  @override
  bool shouldReload(_MaterialLocalizationsKuDelegate old) => false;
}

...
class MaterialLocalizationsSv extends DefaultMaterialLocalizations {
  MaterialLocalizationsSv();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsSvDelegate();
}

class _MaterialLocalizationsSvDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsSvDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsSv();
  }

  @override
  bool shouldReload(_MaterialLocalizationsSvDelegate old) => false;
}

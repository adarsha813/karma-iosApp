...
class CupertinoLocalizationsSt extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsSt();

  // TODO: Add translations for Sesotho
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsStDelegate();
}

class _CupertinoLocalizationsStDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsStDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'st';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsSt();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsStDelegate old) => false;
}

...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get aboutCompanyDescription => '私たちは、ユーザーに最高の占星術体験を提供することに尽力しています。';
  ...
  String get missionDescription =>
      '正確でパーソナライズされた占星術の洞察を提供し、ユーザーが人生において情報に基づいた決定を下せるよう支援します。';

  @override
  String get ourVision => '私たちのビジョン';

  @override
  String get visionDescription => 'テクノロジーと古代の知恵を融合し、最も信頼される占星術プラットフォームになること。';

  @override
  String get ourValues => '私たちの価値観';

  @override
  String get valuesDescription => '誠実さ、正確さ、ユーザー中心の設計、継続的な革新。';
  ...
  @override
  String get paymentRequiredMessage => '無料の質問はご利用いただけました。続行するには ₹50 をお支払いください。';

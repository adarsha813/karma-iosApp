...
class MaterialLocalizationsKy extends DefaultMaterialLocalizations {
  MaterialLocalizationsKy();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsKyDelegate();
}

class _MaterialLocalizationsKyDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsKyDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsKy();
  }

  @override
  bool shouldReload(_MaterialLocalizationsKyDelegate old) => false;
}

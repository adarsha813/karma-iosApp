...
class MaterialLocalizationsSi extends DefaultMaterialLocalizations {
  MaterialLocalizationsSi();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsSiDelegate();
}

class _MaterialLocalizationsSiDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsSi();
  }

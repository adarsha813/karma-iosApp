...
class CupertinoLocalizationsGd extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsGd();

  // TODO: Add translations for Scots Gaelic
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsGdDelegate();
}

class _CupertinoLocalizationsGdDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsGdDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'gd';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsGd();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsGdDelegate old) => false;
}

...
class CupertinoLocalizationsTk extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsTk();

  // TODO: Add translations for Turkmen
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsTkDelegate();
}

class _CupertinoLocalizationsTkDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsTkDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsTk();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsTkDelegate old) => false;
}

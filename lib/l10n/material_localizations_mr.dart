...
class MaterialLocalizationsMr extends DefaultMaterialLocalizations {
  MaterialLocalizationsMr();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsMrDelegate();
}

class _MaterialLocalizationsMrDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsMrDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsMr();
  }

  @override
  bool shouldReload(_MaterialLocalizationsMrDelegate old) => false;
}

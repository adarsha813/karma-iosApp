...
class CupertinoLocalizationsOr extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsOr();

  // TODO: Add translations for Odia (Oriya)
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsOrDelegate();
}

class _CupertinoLocalizationsOrDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsOrDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'or';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsOr();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsOrDelegate old) => false;
}

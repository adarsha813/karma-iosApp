...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'علم التنجيم هو دراسة الأجرام السماوية...';
  ...
  String get onboardingWhyUseAppDesc =>
      'احصل على الأبراج الشخصية والتوقعات اليومية والإرشادات اللازمة لاتخاذ قرارات مستنيرة.';
  ...
  String get onboardingHowToUseDesc =>
      'تنقل بسهولة، وتحقق من الأبراج اليومية، وقم بإدارة ملفك الشخصي للحصول على تنبؤات دقيقة.';
  ...
  String get aboutCompanyDescription =>
      'نحن ملتزمون بتقديم أفضل تجربة في علم التنجيم لمستخدمينا.';
  ...
  String get missionDescription =>
      'توفير رؤى فلكية دقيقة ومخصصة لمساعدة المستخدمين على اتخاذ قرارات مستنيرة في حياتهم.';
  ...
  String get visionDescription =>
      'أن نصبح منصة علم التنجيم الأكثر ثقة، من خلال الجمع بين التكنولوجيا والحكمة القديمة.';
  ...
  String get valuesDescription =>
      'النزاهة والدقة والتصميم الموجه نحو المستخدم والابتكار المستمر.';
  ...
  String get paymentRequiredMessage =>
      'لقد استخدمت أسئلتك المجانية. ادفع ٥٠ روبية للمتابعة.';

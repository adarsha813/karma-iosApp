...
class CupertinoLocalizationsLo extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsLo();

  // TODO: Add translations for Lao
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsLoDelegate();
}

class _CupertinoLocalizationsLoDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsLoDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'lo';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsLo();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsLoDelegate old) => false;
}

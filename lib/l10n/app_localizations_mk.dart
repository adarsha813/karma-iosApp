...
class AppLocalizationsMk extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'Астрологијата е древна наука за небесните движења и нивното влијание врз човечкиот живот, нудејќи увид во личноста, врските и животните настани.';
  ...
  String get onboardingWhyUseAppDesc =>
      'Добивајте точни, човечки генерирани хороскопи и упатства прилагодени на вашата натална карта. Донесувајте информирани одлуки со дневни предвидувања и персонализирани совети од искусни астролози.';
  ...
  String get onboardingHowToUseDesc =>
      'Едноставно внесете го вашиот датум на раѓање, точно време, место на раѓање и сите други релевантни детали за да започнете веднаш. Истражувајте дневни хороскопи, поставувајте прашања до стручни астролози и управувајте со вашиот профил за прецизни, персонализирани предвидувања - не е потребно најавување.';

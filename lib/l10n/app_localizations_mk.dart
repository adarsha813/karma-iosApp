...
class AppLocalizationsMk extends AppLocalizations {
  ...
  String get aboutCompanyDescription =>
      'Посветени сме на тоа да им го обезбедиме најдоброто астролошко искуство на нашите корисници.';
  ...
  String get missionDescription =>
      'Да се обезбедат точни и персонализирани астролошки сознанија за да им се помогне на корисниците да донесат информирани одлуки во своите животи.';
  ...
  String get visionDescription =>
      'Да станеме најдоверлива астролошка платформа, комбинирајќи технологија и древна мудрост.';
  ...
  String get valuesDescription =>
      'Интегритет, точност, дизајн ориентиран кон корисникот и континуирана иновација.';
  ...
  String paymentRequiredMessage(Object amount) {
    return 'Ги искористивте вашите бесплатни прашања. Платете 50 рупии за да продолжите.';
  }

...
class CupertinoLocalizationsIs extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsIs();

  // TODO: Add translations for Icelandic
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsIsDelegate();
}

class _CupertinoLocalizationsIsDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsIsDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'is';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsIs();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsIsDelegate old) => false;
}

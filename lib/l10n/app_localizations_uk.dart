...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get aboutCompanyDescription =>
      'Ми прагнемо забезпечити найкращий астрологічний досвід для наших користувачів.';
  ...
  String get missionDescription =>
      'Надавати точні та персоналізовані астрологічні дані, щоб допомогти користувачам приймати обґрунтовані рішення у своєму житті.';
  ...
  String get visionDescription =>
      'Стати найнадійнішою астрологічною платформою, що поєднує технології та давню мудрість.';
  ...
  String get valuesDescription =>
      'Цілісність, точність, орієнтований на користувача дизайн та постійні інновації.';
  ...
  String get paymentRequiredMessage =>
      'Ви використали свої безкоштовні запитання. Сплатіть 50 рупій, щоб продовжити.';

...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'Астрологія — це давнє вивчення небесних рухів та їхнього впливу на людське життя, яке пропонує розуміння особистості, стосунків та життєвих подій.';
  ...
  String get onboardingWhyUseAppDesc =>
      'Отримуйте точні, згенеровані людиною гороскопи та поради, адаптовані до вашої натальної карти. Приймайте обґрунтовані рішення завдяки щоденним прогнозам та персоналізованим порадам від досвідчених астрологів.';
  ...
  String get onboardingHowToUseDesc =>
      'Просто введіть дату народження, точний час, місце народження та будь-які інші відповідні дані, щоб миттєво розпочати. Переглядайте щоденні гороскопи, ставте запитання досвідченим астрологам і керуйте своїм профілем, щоб отримувати точні, персоналізовані прогнози — без входу в систему.';
  ...
  @override
  String get lightThemeDescription => 'Завжди використовувати світлу тему';

  @override
  String get darkThemeLabel => 'Темний';

  @override
  String get darkThemeDescription => 'Завжди використовувати темну тему';
  ...
  String get systemThemeDarkDescription =>
      'Дотримуйтесь системних налаштувань для темної теми';

  @override
  String get systemThemeLightDescription =>
      'Дотримуйтесь системних налаштувань для світлої теми';

  @override
  String get switchToLight => 'Перейти на світлий режим';

  @override
  String get switchToDark => 'Перейти на темний режим';

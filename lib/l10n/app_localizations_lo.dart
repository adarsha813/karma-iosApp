...
class AppLocalizationsLo extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'ໂຫລາສາດແມ່ນການສຶກສາວັດຖຸບູຮານຂອງການເຄື່ອນໄຫວຂອງຊັ້ນສູງແລະອິດທິພົນຂອງມັນຕໍ່ຊີວິດຂອງມະນຸດ, ສະເຫນີຄວາມເຂົ້າໃຈກ່ຽວກັບບຸກຄະລິກກະພາບ, ຄວາມສໍາພັນ, ແລະເຫດການຊີວິດ.';
  ...
  String get onboardingWhyUseAppDesc =>
      'ໄດ້​ຮັບ​ການ horoscopes ທີ່​ຖືກ​ຕ້ອງ​, ການ​ສ້າງ​ໂດຍ​ມະ​ນຸດ​ແລະ​ການ​ຊີ້​ນໍາ​ເຫມາະ​ສົມ​ກັບ​ຕາ​ຕະ​ລາງ​ການ​ເກີດ​ຂອງ​ທ່ານ​. ຕັດສິນໃຈຢ່າງມີຂໍ້ມູນດ້ວຍການຄາດຄະເນປະຈໍາວັນແລະຄໍາແນະນໍາສ່ວນບຸກຄົນຈາກນັກໂຫລາສາດທີ່ມີປະສົບການ.';
  ...
  String get onboardingHowToUseDesc =>
      'ພຽງແຕ່ໃສ່ວັນເດືອນປີເກີດ, ເວລາທີ່ແນ່ນອນ, ສະຖານທີ່ເກີດ, ແລະລາຍລະອຽດທີ່ກ່ຽວຂ້ອງອື່ນໆເພື່ອເລີ່ມຕົ້ນທັນທີ. ສຳຫຼວດດວງດວງປະຈຳວັນ, ຖາມຄຳຖາມກັບນັກໂຫລາສາດຜູ້ຊ່ຽວຊານ, ແລະຈັດການໂປຣໄຟລ໌ຂອງເຈົ້າເພື່ອການຄາດເດົາທີ່ຊັດເຈນ, ເປັນແບບສ່ວນຕົວ, ບໍ່ຈຳເປັນຕ້ອງເຂົ້າສູ່ລະບົບ.';
  ...
  String get aboutCompanyDescription =>
      'ທີ່ Karma, ພວກເຮົາຊ່ວຍໃຫ້ທ່ານເປີດເຜີຍເສັ້ນທາງຊີວິດທີ່ແທ້ຈິງຂອງທ່ານໂດຍຜ່ານປັນຍາທີ່ບໍ່ມີເວລາຂອງໂຫລາສາດ Vedic. ທຸກໆຄວາມເຂົ້າໃຈແມ່ນມາຈາກນັກໂຫລາສາດທີ່ແທ້ຈິງ, ມີປະສົບການ, ຖືກສ້າງຂື້ນຢ່າງລະມັດລະວັງໂດຍອີງໃສ່ຕາຕະລາງການເກີດທີ່ເປັນເອກະລັກຂອງເຈົ້າ. ຈາກ horoscopes ປະຈໍາວັນຈົນເຖິງຄໍາແນະນໍາສ່ວນບຸກຄົນ, Karma ເຮັດໃຫ້ຄວາມຮູ້ວັດຖຸບູຮານສາມາດເຂົ້າເຖິງໄດ້ຫຼາຍກວ່າ 100 ພາສາ.';
  ...
  String get missionDescription =>
      'ພາລະກິດຂອງພວກເຮົາແມ່ນງ່າຍດາຍ: ເພື່ອສະຫນອງການຊີ້ນໍາທາງໂຫລາສາດທີ່ແທ້ຈິງ, ນໍາພາຂອງມະນຸດທີ່ສ້າງຄວາມເຂັ້ມແຂງໃຫ້ທ່ານເຮັດການຕັດສິນໃຈທີ່ມີຄວາມຫມັ້ນໃຈ. ທຸກໆການຄາດຄະເນແລະການປຶກສາຫາລືສະທ້ອນໃຫ້ເຫັນເຖິງຄວາມຊ່ຽວຊານດ້ານວິຊາຊີບຫຼາຍປີ, ບໍ່ແມ່ນລະບົບອັດຕະໂນມັດ.';
  ...
  String get visionDescription =>
      'ພວກເຮົາພະຍາຍາມເປັນເວທີທີ່ເຊື່ອຖືໄດ້ຫຼາຍທີ່ສຸດໃນໂລກສໍາລັບໂຫລາສາດ Vedic, ຊ່ວຍໃຫ້ຜູ້ຄົນຢູ່ທົ່ວທຸກແຫ່ງເຂົ້າໃຈຕົນເອງ, ການເລືອກຂອງເຂົາເຈົ້າ, ແລະການເດີນທາງຊີວິດຂອງເຂົາເຈົ້າດ້ວຍຄວາມຊັດເຈນແລະຄວາມຫມັ້ນໃຈ.';
  ...
  String get valuesDescription =>
      'ທີ່ Karma, ພວກເຮົາໃຫ້ຄຸນຄ່າຂອງຄວາມຖືກຕ້ອງ, ຄວາມແມ່ນຍໍາ, ແລະຄວາມໄວ້ວາງໃຈ. ພວກເຮົາມຸ່ງຫມັ້ນທີ່ຈະສະເຫນີຄໍາແນະນໍາທີ່ບໍ່ພຽງແຕ່ຖືກຕ້ອງແຕ່ຍັງມີຄວາມຫມາຍ, ຊ່ວຍໃຫ້ທ່ານນໍາທາງຊີວິດດ້ວຍຄວາມເຂົ້າໃຈແລະຄວາມຫມັ້ນໃຈ.';
  ...
  String get teamDescription =>
      'ທີມງານຂອງນັກໂຫລາສາດ Vedic ມືອາຊີບຂອງພວກເຮົານໍາເອົາປະສົບການຫຼາຍປີໃນການຕີຄວາມຫມາຍອິດທິພົນຂອງດາວເຄາະແລະຮູບແບບຊີວິດ. ສະຫນັບສະຫນູນໂດຍທີມງານສະຫນັບສະຫນູນແລະການພັດທະນາທີ່ອຸທິດຕົນ, Karma ສະຫນອງປະສົບການທີ່ລຽບງ່າຍ, ເຊື່ອຖືໄດ້, ແລະທົ່ວໂລກສໍາລັບຜູ້ໃຊ້ທຸກຄົນ.';
}

...
class CupertinoLocalizationsUz extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsUz();

  // TODO: Add translations for Uzbek
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsUzDelegate();
}

class _CupertinoLocalizationsUzDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsUzDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsUz();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsUzDelegate old) => false;
}

...
class MaterialLocalizationsBs extends DefaultMaterialLocalizations {
  MaterialLocalizationsBs();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsBsDelegate();
}

class _MaterialLocalizationsBsDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsBsDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsBs();
  }

  @override
  bool shouldReload(_MaterialLocalizationsBsDelegate old) => false;
}

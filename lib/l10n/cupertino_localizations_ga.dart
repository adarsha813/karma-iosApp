...
class CupertinoLocalizationsGa extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsGa();

  // TODO: Add translations for Irish
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsGaDelegate();
}

class _CupertinoLocalizationsGaDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsGaDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsGa();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsGaDelegate old) => false;
}

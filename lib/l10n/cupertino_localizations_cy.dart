...
class CupertinoLocalizationsCy extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsCy();

  // TODO: Add translations for Welsh
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsCyDelegate();
}

class _CupertinoLocalizationsCyDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsCyDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsCy();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsCyDelegate old) => false;
}

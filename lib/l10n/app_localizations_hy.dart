...
class AppLocalizationsHy extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'Աստղագուշակությունը երկնային շարժումների և դրանց մարդկային կյանքի վրա ազդեցության հնագույն ուսումնասիրություն է, որը հնարավորություն է տալիս պատկերացում կազմել անհատականության, հարաբերությունների և կյանքի իրադարձությունների մասին։';
  ...
  String get onboardingWhyUseAppDesc =>
      'Ստացեք ճշգրիտ, մարդու կողմից ստեղծված հորոսկոպներ և ձեր ծննդյան քարտեզին հարմարեցված ուղեցույց: Կայացրեք տեղեկացված որոշումներ՝ օգտագործելով ամենօրյա կանխատեսումները և փորձառու աստղագուշակների անհատականացված խորհուրդները:';
  ...
  String get onboardingHowToUseDesc =>
      'Պարզապես մուտքագրեք ձեր ծննդյան ամսաթիվը, ճշգրիտ ժամը, ծննդյան վայրը և ցանկացած այլ համապատասխան մանրամասնություն՝ անմիջապես սկսելու համար: Ուսումնասիրեք ամենօրյա հորոսկոպները, հարցեր տվեք փորձառու աստղագուշակներին և կառավարեք ձեր պրոֆիլը՝ ճշգրիտ, անհատականացված կանխատեսումներ ստանալու համար՝ մուտք գործելու կարիք չկա:';
  ...
  String get aboutCompanyDescription =>
      'Karma-ում մենք կօգնենք ձեզ բացահայտել ձեր իրական կյանքի ուղին՝ վեդական աստղագուշակության անժամանակ իմաստության միջոցով: Յուրաքանչյուր պատկերացում գալիս է իրական, փորձառու աստղագուշակներից, որոնք ուշադիր մշակված են ձեր եզակի ծննդյան քարտեզի հիման վրա: Ամենօրյա հորոսկոպներից մինչև անհատականացված ուղեցույց, Karma-ն հին գիտելիքները հասանելի է դարձնում ավելի քան 100 լեզուներով:';
  ...
  String get missionDescription =>
      'Մեր առաքելությունը պարզ է. տրամադրել իսկական, մարդու կողմից առաջնորդվող աստղագուշակական ուղեցույց, որը կօգնի ձեզ կայացնել վստահ և տեղեկացված որոշումներ: Յուրաքանչյուր կանխատեսում և խորհրդատվություն արտացոլում է տարիների մասնագիտական փորձը, այլ ոչ թե ավտոմատացված ալգորիթմները:';
  ...
  String get visionDescription =>
      'Մենք ձգտում ենք լինել աշխարհի ամենահուսալի հարթակը վեդական աստղագուշակության համար՝ օգնելով մարդկանց ամենուրեք հասկանալ իրենց, իրենց ընտրությունները և կյանքի ճանապարհը՝ պարզությամբ և վստահությամբ։';
  ...
  String get valuesDescription =>
      'Karma-ում մենք գնահատում ենք իսկությունը, ճշգրտությունը և վստահությունը: Մենք հանձնառու ենք առաջարկել ոչ միայն ճշգրիտ, այլև իմաստալից ուղեցույց՝ օգնելով ձեզ կյանքում կողմնորոշվել խորաթափանցությամբ և վստահությամբ:';
  ...
  String paymentRequiredMessage(Object amount) {
    return 'Դուք օգտագործել եք ձեր անվճար հարցերը։ Շարունակելու համար վճարեք $amount համարին։';
  }
  ...
  String get teamDescription =>
      'Մեր պրոֆեսիոնալ վեդիկ աստղագուշակների թիմը տարիների փորձ ունի մոլորակային ազդեցությունների և կյանքի օրինաչափությունների մեկնաբանման գործում: Նվիրված աջակցության և զարգացման թիմի աջակցությամբ՝ Karma-ն յուրաքանչյուր օգտատիրոջ համար ապահովում է անխափան, հուսալի և գլոբալ փորձառություն:';
}

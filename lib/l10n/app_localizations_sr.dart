...
class AppLocalizationsSr extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'Астрологија је проучавање небеских тела...';
  ...
  String get onboardingWhyUseAppDesc =>
      'Добијте персонализоване хороскопе, дневне прогнозе и смернице за доношење информисаних одлука.';
  ...
  String get onboardingHowToUseDesc =>
      'Лако се крећите, проверавајте дневне хороскопе и управљајте својим профилом за тачна предвиђања.';
  ...
  String get aboutCompanyDescription =>
      'Посвећени смо пружању најбољег астролошког искуства нашим корисницима.';
  ...
  String get missionDescription =>
      'Да би се пружили тачни и персонализовани астролошки увиди како би се корисницима помогло да доносе информисане одлуке у свом животу.';
  ...
  String get visionDescription =>
      'Да постанемо најпоузданија астролошка платформа, комбинујући технологију и древну мудрост.';
  ...
  String get valuesDescription =>
      'Интегритет, тачност, дизајн усмерен ка кориснику и континуиране иновације.';

  @override
  String get contactUs => 'Контактирајте нас';

  @override
  String get contactEmail => 'Е-пошта: support@yourcompany.com';

  @override
  String get contactWebsite => 'Веб-сајт: www.yourcompany.com';
  ...
  String paymentRequiredMessage(Object amount) {
    return 'Искористили сте своја бесплатна питања. Платите 50 ₹ да бисте наставили.';
  }

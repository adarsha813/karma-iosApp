...
class AppLocalizationsKn extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'ಜ್ಯೋತಿಷ್ಯವು ಆಕಾಶ ಚಲನೆಗಳು ಮತ್ತು ಮಾನವ ಜೀವನದ ಮೇಲೆ ಅವುಗಳ ಪ್ರಭಾವದ ಪ್ರಾಚೀನ ಅಧ್ಯಯನವಾಗಿದ್ದು, ವ್ಯಕ್ತಿತ್ವ, ಸಂಬಂಧಗಳು ಮತ್ತು ಜೀವನ ಘಟನೆಗಳ ಒಳನೋಟಗಳನ್ನು ನೀಡುತ್ತದೆ.';
  ...
  String get onboardingWhyUseAppDesc =>
      'ನಿಮ್ಮ ಜನ್ಮ ಕುಂಡಲಿಗೆ ಅನುಗುಣವಾಗಿ ನಿಖರವಾದ, ಮಾನವ-ರಚಿತ ಜಾತಕಗಳು ಮತ್ತು ಮಾರ್ಗದರ್ಶನವನ್ನು ಪಡೆಯಿರಿ. ಅನುಭವಿ ಜ್ಯೋತಿಷಿಗಳಿಂದ ದೈನಂದಿನ ಭವಿಷ್ಯವಾಣಿಗಳು ಮತ್ತು ವೈಯಕ್ತಿಕಗೊಳಿಸಿದ ಸಲಹೆಯೊಂದಿಗೆ ಮಾಹಿತಿಯುಕ್ತ ನಿರ್ಧಾರಗಳನ್ನು ತೆಗೆದುಕೊಳ್ಳಿ.';
  ...
  String get onboardingHowToUseDesc =>
      'ನಿಮ್ಮ ಜನ್ಮ ದಿನಾಂಕ, ನಿಖರವಾದ ಸಮಯ, ಜನ್ಮ ಸ್ಥಳ ಮತ್ತು ಯಾವುದೇ ಇತರ ಸಂಬಂಧಿತ ವಿವರಗಳನ್ನು ನಮೂದಿಸಿ ಮತ್ತು ತಕ್ಷಣವೇ ಪ್ರಾರಂಭಿಸಿ. ದೈನಂದಿನ ಜಾತಕಗಳನ್ನು ಅನ್ವೇಷಿಸಿ, ತಜ್ಞ ಜ್ಯೋತಿಷಿಗಳಿಗೆ ಪ್ರಶ್ನೆಗಳನ್ನು ಕೇಳಿ ಮತ್ತು ನಿಖರವಾದ, ವೈಯಕ್ತಿಕಗೊಳಿಸಿದ ಭವಿಷ್ಯವಾಣಿಗಳಿಗಾಗಿ ನಿಮ್ಮ ಪ್ರೊಫೈಲ್ ಅನ್ನು ನಿರ್ವಹಿಸಿ - ಯಾವುದೇ ಲಾಗಿನ್ ಅಗತ್ಯವಿಲ್ಲ.';
  ...
  @override
  String get contactEmail => 'ಇಮೇಲ್: care@karmalifepath.com';

  @override
  String get contactWebsite => 'ವೆಬ್‌ಸೈಟ್: www.karmalifepath.com';

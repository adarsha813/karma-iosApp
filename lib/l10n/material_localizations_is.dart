...
class MaterialLocalizationsIs extends DefaultMaterialLocalizations {
  MaterialLocalizationsIs();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsIsDelegate();
}

class _MaterialLocalizationsIsDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsIsDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsIs();
  }

  @override
  bool shouldReload(_MaterialLocalizationsIsDelegate old) => false;
}

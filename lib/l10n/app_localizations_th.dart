...
class AppLocalizationsTh extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'โหราศาสตร์เป็นการศึกษาเกี่ยวกับการเคลื่อนที่ของท้องฟ้าและอิทธิพลที่มีต่อชีวิตมนุษย์ โดยให้ข้อมูลเชิงลึกเกี่ยวกับบุคลิกภาพ ความสัมพันธ์ และเหตุการณ์ในชีวิต';

  @override
  String get onboardingWhyUseApp => 'เหตุใดจึงต้องใช้แอปนี้?';

  @override
  String get onboardingWhyUseAppDesc =>
      'รับคำทำนายดวงชะตาที่แม่นยำและสร้างสรรค์โดยมนุษย์ พร้อมคำแนะนำที่ปรับให้เข้ากับดวงชะตาของคุณ ตัดสินใจอย่างชาญฉลาดด้วยคำทำนายประจำวันและคำแนะนำเฉพาะบุคคลจากนักโหราศาสตร์ผู้มีประสบการณ์';
  ...
  String get onboardingHowToUseDesc =>
      'เพียงกรอกวันเกิด เวลาที่แน่นอน สถานที่เกิด และรายละเอียดอื่นๆ ที่เกี่ยวข้อง เพื่อเริ่มต้นใช้งานได้ทันที สำรวจดวงชะตาประจำวัน ถามคำถามกับนักโหราศาสตร์ผู้เชี่ยวชาญ และจัดการโปรไฟล์ของคุณเพื่อคำทำนายที่แม่นยำและเฉพาะบุคคล โดยไม่ต้องเข้าสู่ระบบ';

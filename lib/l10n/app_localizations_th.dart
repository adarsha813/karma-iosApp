...
class AppLocalizationsTh extends AppLocalizations {
  ...
  String get aboutCompanyDescription =>
      'เรามุ่งมั่นที่จะมอบประสบการณ์โหราศาสตร์ที่ดีที่สุดให้กับผู้ใช้ของเรา';
  ...
  String get missionDescription =>
      'เพื่อให้ข้อมูลเชิงลึกเกี่ยวกับโหราศาสตร์ที่แม่นยำและเฉพาะบุคคลเพื่อช่วยให้ผู้ใช้ตัดสินใจในชีวิตได้อย่างถูกต้อง';
  ...
  String get visionDescription =>
      'เพื่อที่จะกลายเป็นแพลตฟอร์มโหราศาสตร์ที่น่าเชื่อถือที่สุด โดยผสมผสานเทคโนโลยีและภูมิปัญญาโบราณ';
  ...
  String get valuesDescription =>
      'ความซื่อสัตย์ ความแม่นยำ การออกแบบที่เน้นผู้ใช้ และนวัตกรรมอย่างต่อเนื่อง';
  ...
  String paymentRequiredMessage(Object amount) {
    return 'คุณใช้คำถามฟรีของคุณแล้ว จ่าย ₹50 เพื่อดำเนินการต่อ';
  }

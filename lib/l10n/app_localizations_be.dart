...
class AppLocalizationsBe extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'Астралогія — гэта старажытная навука пра рух нябесных зямных шароў і іх уплыў на жыццё чалавека, якая дае разуменне асобы, адносін і жыццёвых падзей.';
  ...
  String get onboardingWhyUseAppDesc =>
      'Атрымлівайце дакладныя, створаныя чалавекам гараскопы і рэкамендацыі, адаптаваныя да вашай натальнай карты. Прымайце абгрунтаваныя рашэнні з дапамогай штодзённых прагнозаў і персаналізаваных парад ад вопытных астролагаў.';
  ...
  String get onboardingHowToUseDesc =>
      'Проста ўвядзіце дату нараджэння, дакладны час, месца нараджэння і любыя іншыя важныя звесткі, каб адразу пачаць. Азнаёмцеся з штодзённымі гараскопамі, задавайце пытанні вопытным астролагам і кіруйце сваім профілем, каб атрымліваць дакладныя, персаналізаваныя прагнозы — уваход у сістэму не патрабуецца.';
  ...
  String get aboutCompanyDescription =>
      'У Karma мы дапамагаем вам раскрыць свой сапраўдны жыццёвы шлях праз вечную мудрасць ведычнай астралогіі. Кожная ідэя паходзіць ад сапраўдных, вопытных астролагаў, старанна распрацаваная на аснове вашай унікальнай карты нараджэння. Ад штодзённых гараскопаў да персаналізаваных парад, Karma робіць старажытныя веды даступнымі на больш чым 100 мовах.';
  ...
  String get missionDescription =>
      'Наша місія простая: даць сапраўдныя астрлагічныя рэкамендацыі, якія праводзяцца пад кіраўніцтвам чалавека, што дасць вам магчымасць прымаць упэўненыя і абгрунтаваныя рашэнні. Кожны прагноз і кансультацыя адлюстроўваюць шматгадовы прафесійны вопыт, а не аўтаматызаваныя алгарытмы.';
  ...
  String get visionDescription =>
      'Мы імкнемся быць самай надзейнай у свеце платформай для ведычнай астралогіі, дапамагаючы людзям паўсюль зразумець сябе, свой выбар і свой жыццёвы шлях з яснасцю і ўпэўненасцю.';
  ...
  String get valuesDescription =>
      'У Karma мы шануем сапраўднасць, дакладнасць і давер. Мы імкнемся прапаноўваць не толькі дакладныя, але і значныя рэкамендацыі, якія дапамагаюць вам арыентавацца ў жыцці з разуменнем і ўпэўненасцю.';
  ...
  @override
  String get themeSettingsTitle => 'Налады тэмы';
  ...
  String get teamDescription =>
      'Наша каманда прафесійных ведычных астролагаў мае шматгадовы вопыт інтэрпрэтацыі планетарных уплываў і жыццёвых мадэляў. Дзякуючы адданай камандзе падтрымкі і распрацоўкі, Karma забяспечвае бесперабойны, надзейны і глабальны вопыт для кожнага карыстальніка.';
}

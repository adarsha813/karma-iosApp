...
class MaterialLocalizationsOr extends DefaultMaterialLocalizations {
  MaterialLocalizationsOr();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsOrDelegate();
}

class _MaterialLocalizationsOrDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsOrDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsOr();
  }

  @override
  bool shouldReload(_MaterialLocalizationsOrDelegate old) => false;
}

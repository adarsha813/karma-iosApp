...
class CupertinoLocalizationsHa extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsHa();

  // TODO: Add translations for Hausa
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsHaDelegate();
}

class _CupertinoLocalizationsHaDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsHaDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsHa();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsHaDelegate old) => false;
}

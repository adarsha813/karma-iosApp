...
class CupertinoLocalizationsAf extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsAf();

  // TODO: Add translations for Afrikaans
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsAfDelegate();
}

class _CupertinoLocalizationsAfDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsAfDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'af';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsAf();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsAfDelegate old) => false;
}

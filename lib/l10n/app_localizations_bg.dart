...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'Астрологията е древното изучаване на небесните движения и тяхното влияние върху човешкия живот, предлагащо прозрения за личността, взаимоотношенията и житейските събития.';
  ...
  String get onboardingWhyUseAppDesc =>
      'Получавайте точни, генерирани от хора хороскопи и насоки, съобразени с вашата рождена карта. Вземайте информирани решения с ежедневни прогнози и персонализирани съвети от опитни астролози.';

  @override
  String get onboardingHowToUse => 'Как да използвате това приложение?';

  @override
  String get onboardingHowToUseDesc =>
      'Просто въведете датата си на раждане, точния час, мястото на раждане и всички други важни подробности, за да започнете незабавно. Разгледайте ежедневните хороскопи, задавайте въпроси на експерти астролози и управлявайте профила си за точни, персонализирани прогнози – не е необходимо влизане.';
  ...
  String get aboutCompanyDescription =>
      'В Карма ви помагаме да разкриете истинския си житейски път чрез вечната мъдрост на ведическата астрология. Всяко прозрение идва от истински, опитни астролози, внимателно изготвени въз основа на вашата уникална рождена карта. От ежедневни хороскопи до персонализирани насоки, Карма прави древните знания достъпни на над 100 езика.';
  ...
  String get missionDescription =>
      'Нашата мисия е проста: да предоставим автентично, водено от човек астрологично ръководство, което ви дава възможност да вземате уверени и информирани решения. Всяка прогноза и консултация отразява дългогодишен професионален опит, а не автоматизирани алгоритми.';
  ...
  String get visionDescription =>
      'Стремим се да бъдем най-доверената платформа за ведическа астрология в света, помагайки на хората навсякъде да разберат себе си, своите избори и своя житейски път с яснота и увереност.';
  ...
  String get valuesDescription =>
      'В Карма ценим автентичността, прецизността и доверието. Ние сме ангажирани да предлагаме насоки, които са не само точни, но и смислени, помагайки ви да се ориентирате в живота с проницателност и увереност.';
  ...
  String paymentRequiredMessage(Object amount) {
    return 'Използвахте безплатните си въпроси. Платете $amount, за да продължите.';
  }
  ...
  @override
  String get lightThemeDescription => 'Винаги използвайте светла тема';

  @override
  String get darkThemeLabel => 'Тъмно';

  @override
  String get darkThemeDescription => 'Винаги използвайте тъмна тема';
  ...
  String get systemThemeDarkDescription =>
      'Следвайте системните настройки за тъмна тема';

  @override
  String get systemThemeLightDescription =>
      'Следвайте системните настройки за светла тема';

  @override
  String get switchToLight => 'Превключване към светлина';

  @override
  String get switchToDark => 'Превключване към тъмно';

  @override
  String get ourTeam => 'Нашият екип';

  @override
  String get teamDescription =>
      'Нашият екип от професионални ведически астролози има дългогодишен опит в тълкуването на планетарни влияния и житейски модели. Подкрепена от всеотдаен екип за поддръжка и разработка, Karma предоставя безпроблемно, надеждно и глобално изживяване за всеки потребител.';
}

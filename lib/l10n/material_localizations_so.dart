...
class MaterialLocalizationsSo extends DefaultMaterialLocalizations {
  MaterialLocalizationsSo();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsSoDelegate();
}

class _MaterialLocalizationsSoDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsSoDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsSo();
  }

  @override
  bool shouldReload(_MaterialLocalizationsSoDelegate old) => false;
}

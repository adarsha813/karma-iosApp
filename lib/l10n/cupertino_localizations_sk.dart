...
class CupertinoLocalizationsSk extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsSk();

  // TODO: Add translations for Slovak
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsSkDelegate();
}

class _CupertinoLocalizationsSkDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsSkDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'sk';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsSk();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsSkDelegate old) => false;
}

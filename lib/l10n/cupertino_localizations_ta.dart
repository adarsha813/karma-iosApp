...
class CupertinoLocalizationsTa extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsTa();

  // TODO: Add translations for Tamil
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsTaDelegate();
}

class _CupertinoLocalizationsTaDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsTaDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'ta';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsTa();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsTaDelegate old) => false;
}

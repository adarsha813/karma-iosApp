...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'Η αστρολογία είναι η αρχαία μελέτη των ουράνιων κινήσεων και της επιρροής τους στην ανθρώπινη ζωή, προσφέροντας γνώσεις για την προσωπικότητα, τις σχέσεις και τα γεγονότα της ζωής.';
  ...
  String get onboardingWhyUseAppDesc =>
      'Λάβετε ακριβή, ανθρωπογενή ωροσκόπια και καθοδήγηση προσαρμοσμένη στον γενέθλιο χάρτη σας. Λάβετε τεκμηριωμένες αποφάσεις με καθημερινές προβλέψεις και εξατομικευμένες συμβουλές από έμπειρους αστρολόγους.';
  ...
  String get onboardingHowToUseDesc =>
      'Απλώς εισάγετε την ημερομηνία γέννησής σας, την ακριβή ώρα, τον τόπο γέννησής σας και οποιεσδήποτε άλλες σχετικές λεπτομέρειες για να ξεκινήσετε αμέσως. Εξερευνήστε καθημερινά ωροσκόπια, κάντε ερωτήσεις σε έμπειρους αστρολόγους και διαχειριστείτε το προφίλ σας για ακριβείς, εξατομικευμένες προβλέψεις—δεν απαιτείται σύνδεση.';
  ...
  String get aboutCompanyDescription =>
      'Στο Karma, σας βοηθάμε να ανακαλύψετε την αληθινή σας πορεία ζωής μέσα από τη διαχρονική σοφία της Βεδικής αστρολογίας. Κάθε πληροφορία προέρχεται από πραγματικούς, έμπειρους αστρολόγους, προσεκτικά διαμορφωμένη με βάση τον μοναδικό σας γενέθλιο χάρτη. Από τα καθημερινά ωροσκόπια μέχρι την εξατομικευμένη καθοδήγηση, το Karma κάνει την αρχαία γνώση προσβάσιμη σε πάνω από 100 γλώσσες.';
  ...
  String get missionDescription =>
      'Η αποστολή μας είναι απλή: να παρέχουμε αυθεντική, αστρολογική καθοδήγηση με επικεφαλής τον άνθρωπο, που σας δίνει τη δυνατότητα να λαμβάνετε σίγουρες και τεκμηριωμένες αποφάσεις. Κάθε πρόβλεψη και συμβουλευτική αντικατοπτρίζει χρόνια επαγγελματικής εμπειρίας και όχι αυτοματοποιημένους αλγόριθμους.';
  ...
  String get visionDescription =>
      'Προσπαθούμε να είμαστε η πιο αξιόπιστη πλατφόρμα στον κόσμο για τη Βεδική αστρολογία, βοηθώντας τους ανθρώπους παντού να κατανοήσουν τον εαυτό τους, τις επιλογές τους και το ταξίδι της ζωής τους με σαφήνεια και αυτοπεποίθηση.';
  ...
  String get valuesDescription =>
      'Στην Karma, εκτιμούμε την αυθεντικότητα, την ακρίβεια και την εμπιστοσύνη. Δεσμευόμαστε να προσφέρουμε καθοδήγηση που δεν είναι μόνο ακριβής αλλά και ουσιαστική, βοηθώντας σας να πλοηγηθείτε στη ζωή με διορατικότητα και αυτοπεποίθηση.';
  ...
  String paymentRequiredMessage(Object amount) {
    return 'Έχετε χρησιμοποιήσει τις δωρεάν ερωτήσεις σας. Πληρώστε $amount για να συνεχίσετε.';
  }
  ...
  String get lightThemeDescription =>
      'Να χρησιμοποιείτε πάντα ανοιχτόχρωμο θέμα';

  @override
  String get darkThemeLabel => 'Σκοτάδι';

  @override
  String get darkThemeDescription => 'Να χρησιμοποιείται πάντα σκούρο θέμα';
  ...
  String get systemThemeDarkDescription =>
      'Ακολουθήστε τη ρύθμιση συστήματος για το σκούρο θέμα';

  @override
  String get systemThemeLightDescription =>
      'Ακολουθήστε τη ρύθμιση συστήματος για το ανοιχτό θέμα';

  @override
  String get switchToLight => 'Αλλαγή σε Φως';

  @override
  String get switchToDark => 'Αλλαγή σε Σκούρο';

  @override
  String get ourTeam => 'Η ομάδα μας';

  @override
  String get teamDescription =>
      'Η ομάδα μας από επαγγελματίες Βεδικούς αστρολόγους διαθέτει πολυετή εμπειρία στην ερμηνεία πλανητικών επιρροών και μοτίβων ζωής. Υποστηριζόμενη από μια αφοσιωμένη ομάδα υποστήριξης και ανάπτυξης, το Karma προσφέρει μια απρόσκοπτη, αξιόπιστη και παγκόσμια εμπειρία για κάθε χρήστη.';
}

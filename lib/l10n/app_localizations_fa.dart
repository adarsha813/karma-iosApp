...
class AppLocalizationsFa extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'طالع بینی مطالعه باستانی حرکات آسمانی و تأثیر آنها بر زندگی انسان است و بینش هایی در مورد شخصیت، روابط و رویدادهای زندگی ارائه می دهد.';
  ...
  String get onboardingWhyUseAppDesc =>
      'فال و طالع بینی دقیق و انسانی متناسب با نمودار تولد خود را دریافت کنید. با پیش بینی های روزانه و توصیه های شخصی از طالع بینان باتجربه، تصمیمات آگاهانه بگیرید.';
  ...
  String get onboardingHowToUseDesc =>
      'کافیست تاریخ تولد، زمان دقیق، محل تولد و سایر جزئیات مربوطه را وارد کنید تا فوراً شروع به کار کنید. فال روزانه را بررسی کنید، از طالع‌بینان متخصص سوال بپرسید و پروفایل خود را برای پیش‌بینی‌های دقیق و شخصی‌سازی‌شده مدیریت کنید - نیازی به ورود نیست.';

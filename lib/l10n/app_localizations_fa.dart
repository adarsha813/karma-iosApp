...
class AppLocalizationsFa extends AppLocalizations {
  ...
  String get aboutCompanyDescription =>
      'ما متعهد به ارائه بهترین تجربه طالع بینی به کاربران خود هستیم.';
  ...
  String get missionDescription =>
      'ارائه بینش‌های طالع‌بینی دقیق و شخصی‌سازی‌شده برای کمک به کاربران در تصمیم‌گیری‌های آگاهانه در زندگی‌شان.';
  ...
  String get visionDescription =>
      'برای تبدیل شدن به معتبرترین پلتفرم طالع بینی، با ترکیب فناوری و خرد باستانی.';
  ...
  String get valuesDescription =>
      'صداقت، دقت، طراحی کاربر محور و نوآوری مستمر.';

...
class MaterialLocalizationsSr extends DefaultMaterialLocalizations {
  MaterialLocalizationsSr();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsSrDelegate();
}

class _MaterialLocalizationsSrDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsSrDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsSr();
  }

  @override
  bool shouldReload(_MaterialLocalizationsSrDelegate old) => false;
}

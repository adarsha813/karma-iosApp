...
class CupertinoLocalizationsBn extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsBn();

  // TODO: Add translations for Bengali
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsBnDelegate();
}

class _CupertinoLocalizationsBnDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsBnDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsBn();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsBnDelegate old) => false;
}

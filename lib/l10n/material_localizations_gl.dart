...
class MaterialLocalizationsGl extends DefaultMaterialLocalizations {
  MaterialLocalizationsGl();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsGlDelegate();
}

class _MaterialLocalizationsGlDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsGlDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsGl();
  }

  @override
  bool shouldReload(_MaterialLocalizationsGlDelegate old) => false;
}

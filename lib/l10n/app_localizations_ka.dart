...
class AppLocalizationsKa extends AppLocalizations {
  ...
  String get aboutCompanyDescription =>
      'ჩვენ ვალდებულნი ვართ, ჩვენს მომხმარებლებს საუკეთესო ასტროლოგიური გამოცდილება შევთავაზოთ.';
  ...
  String get missionDescription =>
      'ზუსტი და პერსონალიზებული ასტროლოგიური ინფორმაციის მიწოდება, რათა მომხმარებლებს დაეხმაროს ცხოვრებაში ინფორმირებული გადაწყვეტილებების მიღებაში.';
  ...
  String get visionDescription =>
      'გახდეს ყველაზე სანდო ასტროლოგიური პლატფორმა, რომელიც აერთიანებს ტექნოლოგიასა და უძველეს სიბრძნეს.';
  ...
  String get valuesDescription =>
      'მთლიანობა, სიზუსტე, მომხმარებელზე ორიენტირებული დიზაინი და უწყვეტი ინოვაცია.';

...
class AppLocalizationsKa extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'ასტროლოგია ციური მოძრაობებისა და მათი ადამიანის ცხოვრებაზე გავლენის უძველესი შესწავლაა, რაც პიროვნების, ურთიერთობებისა და ცხოვრებისეული მოვლენების შესახებ ინფორმაციას გვთავაზობს.';

  @override
  String get onboardingWhyUseApp => 'რატომ გამოვიყენოთ ეს აპლიკაცია?';

  @override
  String get onboardingWhyUseAppDesc =>
      'მიიღეთ ზუსტი, ადამიანის მიერ გენერირებული ჰოროსკოპები და თქვენს დაბადების რუკაზე მორგებული რჩევები. მიიღეთ ინფორმირებული გადაწყვეტილებები ყოველდღიური პროგნოზებითა და გამოცდილი ასტროლოგების პერსონალიზებული რჩევებით.';
  ...
  String get onboardingHowToUseDesc =>
      'უბრალოდ შეიყვანეთ თქვენი დაბადების თარიღი, ზუსტი დრო, დაბადების ადგილი და ნებისმიერი სხვა შესაბამისი დეტალი, რომ მყისიერად დაიწყოთ. გაეცანით ყოველდღიურ ჰოროსკოპებს, დაუსვით კითხვები ექსპერტ ასტროლოგებს და მართეთ თქვენი პროფილი ზუსტი, პერსონალიზებული პროგნოზებისთვის - შესვლა საჭირო არ არის.';

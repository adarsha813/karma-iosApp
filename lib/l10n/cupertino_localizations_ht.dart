...
class CupertinoLocalizationsHt extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsHt();

  // TODO: Add translations for Haitian Creole
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsHtDelegate();
}

class _CupertinoLocalizationsHtDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsHtDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsHt();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsHtDelegate old) => false;
}

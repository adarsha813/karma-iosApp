...
class MaterialLocalizationsHmn extends DefaultMaterialLocalizations {
  MaterialLocalizationsHmn();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsHmnDelegate();
}

class _MaterialLocalizationsHmnDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsHmnDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsHmn();
  }

  @override
  bool shouldReload(_MaterialLocalizationsHmnDelegate old) => false;
}

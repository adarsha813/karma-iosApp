...
class CupertinoLocalizationsZu extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsZu();

  // TODO: Add translations for Zulu
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsZuDelegate();
}

class _CupertinoLocalizationsZuDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsZuDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsZu();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsZuDelegate old) => false;
}

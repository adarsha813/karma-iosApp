...
class MaterialLocalizationsTt extends DefaultMaterialLocalizations {
  MaterialLocalizationsTt();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsTtDelegate();
}

class _MaterialLocalizationsTtDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsTtDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsTt();
  }

  @override
  bool shouldReload(_MaterialLocalizationsTtDelegate old) => false;
}

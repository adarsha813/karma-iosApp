...
class MaterialLocalizationsAz extends DefaultMaterialLocalizations {
  MaterialLocalizationsAz();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsAzDelegate();
}

class _MaterialLocalizationsAzDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsAzDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsAz();
  }

  @override
  bool shouldReload(_MaterialLocalizationsAzDelegate old) => false;
}

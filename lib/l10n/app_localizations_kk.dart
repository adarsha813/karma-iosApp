...
class AppLocalizationsKk extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'Астрология – аспан денелерін зерттейтін ғылым...';

  @override
  String get onboardingWhyUseApp => 'Неліктен бұл қолданбаны пайдалану керек?';

  @override
  String get onboardingWhyUseAppDesc =>
      'Саналы шешім қабылдау үшін жеке жұлдыз жорамалдарын, күнделікті болжамдарды және нұсқауларды алыңыз.';
  ...
  String get onboardingHowToUseDesc =>
      'Оңай шарлаңыз, күнделікті жұлдыз жорамалдарды тексеріңіз және дәл болжамдар үшін профиліңізді басқарыңыз.';
  ...
  String get aboutCompanyDescription =>
      'Біз пайдаланушыларымызға ең жақсы астрология тәжірибесін жеткізуге дайынбыз.';
  ...
  String get missionDescription =>
      'Пайдаланушыларға өмірлерінде негізделген шешімдер қабылдауға көмектесу үшін дәл және жекеленген астрологиялық түсініктерді қамтамасыз ету.';
  ...
  String get visionDescription =>
      'Технология мен ежелгі даналықты біріктіретін ең сенімді астрологиялық платформа болу.';
  ...
  String get valuesDescription =>
      'Тұтастық, дәлдік, пайдаланушыға бағытталған дизайн және үздіксіз инновация.';

...
class AppLocalizationsPs extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'ستورپوهنه د آسماني حرکتونو او د انسان په ژوند باندې د هغوی د نفوذ لرغونی مطالعه ده، چې د شخصیت، اړیکو او د ژوند پیښو په اړه بصیرت وړاندې کوي.';
  ...
  String get onboardingWhyUseAppDesc =>
      'د انسان لخوا رامینځته شوي دقیق افقونه او لارښوونې ترلاسه کړئ چې ستاسو د زیږون چارټ سره سم وي. د ورځني وړاندوینو او د تجربه لرونکو ستورپوهانو شخصي مشورې سره باخبره پریکړې وکړئ.';
  ...
  String get onboardingHowToUseDesc =>
      'په ساده ډول د خپل زیږون نیټه، دقیق وخت، د زیږون ځای، او نور اړوند توضیحات دننه کړئ ترڅو سمدلاسه پیل وکړئ. ورځني افقونه وپلټئ، له ماهر ستورپوهانو څخه پوښتنې وکړئ، او د دقیقو، شخصي وړاندوینو لپاره خپل پروفایل اداره کړئ — د ننوتلو اړتیا نشته.';
  ...
  String get aboutCompanyDescription =>
      'په کرما کې، موږ ستاسو سره د ویدیک ستورپوهنې د تلپاتې حکمت له لارې ستاسو د ژوند ریښتینې لاره موندلو کې مرسته کوو. هر بصیرت د ریښتیني، تجربه لرونکو ستورپوهانو څخه راځي، چې ستاسو د ځانګړي زیږون چارټ پراساس په احتیاط سره جوړ شوي. د ورځني افقونو څخه تر شخصي لارښوونې پورې، کرما لرغوني پوهه په 100 څخه زیاتو ژبو کې د لاسرسي وړ ګرځوي.';
  ...
  String get missionDescription =>
      'زموږ ماموریت ساده دی: د انسان په مشرۍ د ستورپوهنې مستند لارښوونې چمتو کول چې تاسو ته د باوري او باخبره پریکړو کولو ځواک درکوي. هره وړاندوینه او مشوره د کلونو مسلکي تخصص منعکس کوي، نه اتومات الګوریتمونه.';
  ...
  String get visionDescription =>
      'موږ هڅه کوو چې د ویدیک ستورپوهنې لپاره د نړۍ ترټولو باوري پلیټ فارم واوسو، چې خلکو سره مرسته وکړي چې په هر ځای کې ځانونه، د دوی انتخابونه، او د دوی د ژوند سفر په روښانه او باور سره پوه شي.';
  ...
  String get valuesDescription =>
      'په کرما کې، موږ صداقت، دقت او باور ته ارزښت ورکوو. موږ ژمن یو چې داسې لارښوونې وړاندې کړو چې نه یوازې دقیقې وي بلکې معنی لرونکې هم وي، چې تاسو سره د ژوند په بصیرت او باور سره په لاره اچولو کې مرسته وکړي.';

  @override
  String get contactUs => 'موږ سره اړیکه ونیسئ';

  @override
  String get contactEmail => 'برېښنالیک: care@karmalifepath.com';

  @override
  String get contactWebsite => 'ویب پاڼه: www.karmalifepath.com';
  ...
  String get teamDescription =>
      'زموږ د مسلکي ویدیک ستورپوهانو ټیم د سیارې اغیزو او د ژوند نمونو تشریح کولو کې د کلونو تجربه لري. د وقف شوي ملاتړ او پراختیا ټیم لخوا ملاتړ شوی، کرما د هر کارونکي لپاره بې سیمه، باوري او نړیواله تجربه وړاندې کوي.';
}

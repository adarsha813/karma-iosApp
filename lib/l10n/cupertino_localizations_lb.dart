...
class CupertinoLocalizationsLb extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsLb();

  // TODO: Add translations for Luxembourgish
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsLbDelegate();
}

class _CupertinoLocalizationsLbDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsLbDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsLb();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsLbDelegate old) => false;
}

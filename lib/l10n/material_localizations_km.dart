...
class MaterialLocalizationsKm extends DefaultMaterialLocalizations {
  MaterialLocalizationsKm();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsKmDelegate();
}

class _MaterialLocalizationsKmDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsKmDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsKm();
  }

  @override
  bool shouldReload(_MaterialLocalizationsKmDelegate old) => false;
}

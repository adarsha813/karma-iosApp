...
class MaterialLocalizationsKk extends DefaultMaterialLocalizations {
  MaterialLocalizationsKk();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsKkDelegate();
}

class _MaterialLocalizationsKkDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsKkDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsKk();
  }

  @override
  bool shouldReload(_MaterialLocalizationsKkDelegate old) => false;
}

...
class MaterialLocalizationsTk extends DefaultMaterialLocalizations {
  MaterialLocalizationsTk();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsTkDelegate();
}

class _MaterialLocalizationsTkDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsTkDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsTk();
  }

  @override
  bool shouldReload(_MaterialLocalizationsTkDelegate old) => false;
}

...
class MaterialLocalizationsLo extends DefaultMaterialLocalizations {
  MaterialLocalizationsLo();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsLoDelegate();
}

class _MaterialLocalizationsLoDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsLoDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsLo();
  }

  @override
  bool shouldReload(_MaterialLocalizationsLoDelegate old) => false;
}

...
class MaterialLocalizationsMk extends DefaultMaterialLocalizations {
  MaterialLocalizationsMk();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsMkDelegate();
}

class _MaterialLocalizationsMkDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsMkDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsMk();
  }

  @override
  bool shouldReload(_MaterialLocalizationsMkDelegate old) => false;
}

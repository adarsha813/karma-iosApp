...
class AppLocalizationsGu extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'જ્યોતિષ શાસ્ત્ર એ અવકાશી ગતિવિધિઓ અને માનવ જીવન પર તેમના પ્રભાવનો પ્રાચીન અભ્યાસ છે, જે વ્યક્તિત્વ, સંબંધો અને જીવનની ઘટનાઓમાં આંતરદૃષ્ટિ પ્રદાન કરે છે.';
  ...
  String get onboardingWhyUseAppDesc =>
      'તમારા જન્મ ચાર્ટ અનુસાર સચોટ, માનવ-નિર્મિત જન્માક્ષર અને માર્ગદર્શન મેળવો. અનુભવી જ્યોતિષીઓ પાસેથી દૈનિક આગાહીઓ અને વ્યક્તિગત સલાહ સાથે જાણકાર નિર્ણયો લો.';
  ...
  String get onboardingHowToUseDesc =>
      'તરત જ શરૂઆત કરવા માટે ફક્ત તમારી જન્મ તારીખ, ચોક્કસ સમય, જન્મ સ્થળ અને અન્ય કોઈપણ સંબંધિત વિગતો દાખલ કરો. દૈનિક જન્માક્ષરોનું અન્વેષણ કરો, નિષ્ણાત જ્યોતિષીઓને પ્રશ્નો પૂછો અને ચોક્કસ, વ્યક્તિગત આગાહીઓ માટે તમારી પ્રોફાઇલ મેનેજ કરો - કોઈ લોગિન જરૂરી નથી.';
  ...
  String get aboutCompanyDescription =>
      'કર્મ ખાતે, અમે તમને વૈદિક જ્યોતિષના શાશ્વત જ્ઞાન દ્વારા તમારા સાચા જીવન માર્ગને ઉજાગર કરવામાં મદદ કરીએ છીએ. દરેક સમજ વાસ્તવિક, અનુભવી જ્યોતિષીઓ પાસેથી આવે છે, જે તમારા અનન્ય જન્મકુંડળીના આધારે કાળજીપૂર્વક રચાયેલ છે. દૈનિક જન્માક્ષરથી લઈને વ્યક્તિગત માર્ગદર્શન સુધી, કર્મ પ્રાચીન જ્ઞાનને 100 થી વધુ ભાષાઓમાં સુલભ બનાવે છે.';
  ...
  String get missionDescription =>
      'અમારું ધ્યેય સરળ છે: અધિકૃત, માનવ-આગેવાની હેઠળનું જ્યોતિષીય માર્ગદર્શન પૂરું પાડવાનું જે તમને આત્મવિશ્વાસપૂર્ણ, જાણકાર નિર્ણયો લેવા માટે સશક્ત બનાવે છે. દરેક આગાહી અને પરામર્શ વર્ષોની વ્યાવસાયિક કુશળતાને પ્રતિબિંબિત કરે છે, સ્વચાલિત અલ્ગોરિધમ્સને નહીં.';
  ...
  String get visionDescription =>
      'અમે વૈદિક જ્યોતિષ માટે વિશ્વનું સૌથી વિશ્વસનીય પ્લેટફોર્મ બનવાનો પ્રયત્ન કરીએ છીએ, જે દરેક જગ્યાએ લોકોને પોતાને, તેમની પસંદગીઓ અને તેમની જીવનયાત્રાને સ્પષ્ટતા અને આત્મવિશ્વાસ સાથે સમજવામાં મદદ કરે છે.';
  ...
  String get valuesDescription =>
      'કર્મ ખાતે, અમે પ્રમાણિકતા, ચોકસાઈ અને વિશ્વાસને મહત્વ આપીએ છીએ. અમે એવું માર્ગદર્શન આપવા માટે પ્રતિબદ્ધ છીએ જે ફક્ત સચોટ જ નહીં પણ અર્થપૂર્ણ પણ હોય, જે તમને જીવનને સૂઝ અને આત્મવિશ્વાસ સાથે આગળ વધારવામાં મદદ કરે.';

  @override
  String get contactUs => 'અમારો સંપર્ક કરો';

  @override
  String get contactEmail => 'ઇમેઇલ: care@karmalifepath.com';

  @override
  String get contactWebsite => 'વેબસાઇટ: www.karmalifepath.com';
  ...
  String get teamDescription =>
      'અમારી વ્યાવસાયિક વૈદિક જ્યોતિષીઓની ટીમ ગ્રહોના પ્રભાવ અને જીવન પેટર્નનું અર્થઘટન કરવામાં વર્ષોનો અનુભવ ધરાવે છે. સમર્પિત સમર્થન અને વિકાસ ટીમ દ્વારા સમર્થિત, કર્મ દરેક વપરાશકર્તા માટે એક સરળ, વિશ્વસનીય અને વૈશ્વિક અનુભવ પ્રદાન કરે છે.';
}

...
class MaterialLocalizationsHt extends DefaultMaterialLocalizations {
  MaterialLocalizationsHt();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsHtDelegate();
}

class _MaterialLocalizationsHtDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsHtDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsHt();
  }

  @override
  bool shouldReload(_MaterialLocalizationsHtDelegate old) => false;
}

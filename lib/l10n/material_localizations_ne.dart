...
class MaterialLocalizationsNe extends DefaultMaterialLocalizations {
  MaterialLocalizationsNe();

  // TODO: Add translations for Nepali
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsNeDelegate();
}

class _MaterialLocalizationsNeDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsNeDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsNe();
  }

  @override
  bool shouldReload(_MaterialLocalizationsNeDelegate old) => false;
}

...
class MaterialLocalizationsGa extends DefaultMaterialLocalizations {
  MaterialLocalizationsGa();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsGaDelegate();
}

class _MaterialLocalizationsGaDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsGaDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsGa();
  }

  @override
  bool shouldReload(_MaterialLocalizationsGaDelegate old) => false;
}

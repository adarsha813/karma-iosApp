...
class MaterialLocalizationsMi extends DefaultMaterialLocalizations {
  MaterialLocalizationsMi();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsMiDelegate();
}

class _MaterialLocalizationsMiDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsMiDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsMi();
  }

  @override
  bool shouldReload(_MaterialLocalizationsMiDelegate old) => false;
}

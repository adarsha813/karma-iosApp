...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'Астрология — это наука о небесных телах...';
  ...
  String get onboardingWhyUseAppDesc =>
      'Получайте персонализированные гороскопы, ежедневные прогнозы и рекомендации для принятия обоснованных решений.';
  ...
  String get onboardingHowToUseDesc =>
      'Легко ориентируйтесь, проверяйте ежедневные гороскопы и управляйте своим профилем для получения точных прогнозов.';
  ...
  String get aboutCompanyDescription =>
      'Мы стремимся предоставить нашим пользователям наилучший опыт в области астрологии.';
  ...
  String get missionDescription =>
      'Предоставлять точную и персонализированную астрологическую информацию, помогающую пользователям принимать обоснованные решения в своей жизни.';
  ...
  String get visionDescription =>
      'Стать самой надежной астрологической платформой, сочетающей технологии и древнюю мудрость.';
  ...
  String get valuesDescription =>
      'Целостность, точность, ориентированный на пользователя дизайн и постоянные инновации.';
  ...
  String paymentRequiredMessage(Object amount) {
    return 'Вы использовали бесплатные вопросы. Заплатите 50 ₹, чтобы продолжить.';
  }

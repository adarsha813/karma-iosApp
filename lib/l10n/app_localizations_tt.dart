...
class AppLocalizationsTt extends AppLocalizations {
  ...
  String get aboutCompanyDescription =>
      'Без кулланучыларга иң яхшы астрология тәҗрибәсен җиткерергә әзер.';
  ...
  String get missionDescription =>
      'Кулланучыларга тормышларында мәгълүматлы карарлар кабул итәр өчен, төгәл һәм персональләштерелгән астрология күзаллаулары бирү.';
  ...
  String get visionDescription =>
      'Технология белән борыңгы зирәклекне берләштереп, иң ышанычлы астрология платформасы булырга.';
  ...
  String get valuesDescription =>
      'Сафлык, төгәллек, кулланучы-үзәк дизайны, өзлексез инновация.';

...
class AppLocalizationsTt extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'Астрология - күк хәрәкәтләрен һәм аларның кеше тормышына тәэсирен борыңгы өйрәнү, шәхес, мөнәсәбәтләр, тормыш вакыйгалары турында мәгълүмат бирә.';
  ...
  String get onboardingWhyUseAppDesc =>
      'Туган схемага туры килгән төгәл, кеше тудырган гороскопларны һәм җитәкчелекне алыгыз. Көндәлек фаразлар һәм тәҗрибәле астрологларның шәхси киңәшләре белән мәгълүматлы карарлар кабул итегез.';
  ...
  String get onboardingHowToUseDesc =>
      'Шунда ук башлау өчен туган көнегезне, төгәл вакытны, туган урыныгызны һәм башка кирәкле детальләрне кертегез. Көндәлек гороскопларны барлагыз, белгеч астрологларга сораулар бирегез, төгәл, персональләштерелгән фаразлар өчен профилегез белән идарә итегез - логин кирәк түгел.';

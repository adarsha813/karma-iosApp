...
class MaterialLocalizationsTl extends DefaultMaterialLocalizations {
  MaterialLocalizationsTl();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsTlDelegate();
}

class _MaterialLocalizationsTlDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsTlDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsTl();
  }

  @override
  bool shouldReload(_MaterialLocalizationsTlDelegate old) => false;
}

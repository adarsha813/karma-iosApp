...
class CupertinoLocalizationsSr extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsSr();

  // TODO: Add translations for Serbian
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsSrDelegate();
}

class _CupertinoLocalizationsSrDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsSrDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsSr();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsSrDelegate old) => false;
}

...
class CupertinoLocalizationsIg extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsIg();

  // TODO: Add translations for Igbo
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsIgDelegate();
}

class _CupertinoLocalizationsIgDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsIgDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsIg();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsIgDelegate old) => false;
}

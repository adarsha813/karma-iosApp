...
class MaterialLocalizationsKn extends DefaultMaterialLocalizations {
  MaterialLocalizationsKn();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsKnDelegate();
}

class _MaterialLocalizationsKnDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsKnDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsKn();
  }

  @override
  bool shouldReload(_MaterialLocalizationsKnDelegate old) => false;
}

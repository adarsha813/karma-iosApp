...
class MaterialLocalizationsXh extends DefaultMaterialLocalizations {
  MaterialLocalizationsXh();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsXhDelegate();
}

class _MaterialLocalizationsXhDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsXhDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsXh();
  }

  @override
  bool shouldReload(_MaterialLocalizationsXhDelegate old) => false;
}

...
class CupertinoLocalizationsPs extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsPs();

  // TODO: Add translations for Pashto
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsPsDelegate();
}

class _CupertinoLocalizationsPsDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsPsDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsPs();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsPsDelegate old) => false;
}

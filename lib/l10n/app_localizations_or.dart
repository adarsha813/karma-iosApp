...
class AppLocalizationsOr extends AppLocalizations {
  ...
  String get onboardingWhatIsAstrologyDesc =>
      'ଜ୍ୟୋତିଷ ଶାସ୍ତ୍ର ହେଉଛି ସ୍ୱର୍ଗୀୟ ଗତିବିଧି ଏବଂ ମାନବ ଜୀବନ ଉପରେ ସେମାନଙ୍କର ପ୍ରଭାବର ପ୍ରାଚୀନ ଅଧ୍ୟୟନ, ଯାହା ବ୍ୟକ୍ତିତ୍ୱ, ସମ୍ପର୍କ ଏବଂ ଜୀବନ ଘଟଣାଗୁଡ଼ିକ ବିଷୟରେ ଅନ୍ତର୍ଦୃଷ୍ଟି ପ୍ରଦାନ କରେ।';
  ...
  String get onboardingWhyUseAppDesc =>
      'ଆପଣଙ୍କ ଜନ୍ମ ଚାର୍ଟ ଅନୁସାରେ ସଠିକ୍, ମାନବ-ସୃଷ୍ଟ ରାଶିଫଳ ଏବଂ ମାର୍ଗଦର୍ଶନ ପାଆନ୍ତୁ। ଦୈନନ୍ଦିନ ଭବିଷ୍ୟବାଣୀ ଏବଂ ଅଭିଜ୍ଞ ଜ୍ୟୋତିଷମାନଙ୍କଠାରୁ ବ୍ୟକ୍ତିଗତ ପରାମର୍ଶ ସହିତ ସୂଚିତ ନିଷ୍ପତ୍ତି ନିଅନ୍ତୁ।';
  ...
  String get onboardingHowToUseDesc =>
      'ତୁରନ୍ତ ଆରମ୍ଭ କରିବା ପାଇଁ କେବଳ ଆପଣଙ୍କର ଜନ୍ମ ତାରିଖ, ସଠିକ୍ ସମୟ, ଜନ୍ମ ସ୍ଥାନ ଏବଂ ଅନ୍ୟାନ୍ୟ ପ୍ରାସଙ୍ଗିକ ବିବରଣୀ ପ୍ରବେଶ କରନ୍ତୁ। ଦୈନିକ ରାଶିଫଳ ଅନୁସନ୍ଧାନ କରନ୍ତୁ, ବିଶେଷଜ୍ଞ ଜ୍ୟୋତିଷମାନଙ୍କୁ ପ୍ରଶ୍ନ ପଚାରନ୍ତୁ, ଏବଂ ସଠିକ୍, ବ୍ୟକ୍ତିଗତ ଭବିଷ୍ୟବାଣୀ ପାଇଁ ଆପଣଙ୍କର ପ୍ରୋଫାଇଲ୍ ପରିଚାଳନା କରନ୍ତୁ - କୌଣସି ଲଗଇନ୍ ଆବଶ୍ୟକ ନାହିଁ।';
  ...
  String get aboutCompanyDescription =>
      'କର୍ମାରେ, ଆମେ ଆପଣଙ୍କୁ ବୈଦିକ ଜ୍ୟୋତିଷର କାଳଜୟୀ ଜ୍ଞାନ ମାଧ୍ୟମରେ ଆପଣଙ୍କ ପ୍ରକୃତ ଜୀବନ ପଥକୁ ଉନ୍ମୋଚନ କରିବାରେ ସାହାଯ୍ୟ କରୁ। ପ୍ରତ୍ୟେକ ଅନ୍ତର୍ଦୃଷ୍ଟି ପ୍ରକୃତ, ଅଭିଜ୍ଞ ଜ୍ୟୋତିଷଙ୍କଠାରୁ ଆସିଥାଏ, ଯାହା ଆପଣଙ୍କ ଅନନ୍ୟ ଜନ୍ମ ଚାର୍ଟ ଉପରେ ସାବଧାନତାର ସହିତ ପ୍ରସ୍ତୁତ କରାଯାଇଛି। ଦୈନନ୍ଦିନ ରାଶିଫଳରୁ ବ୍ୟକ୍ତିଗତ ମାର୍ଗଦର୍ଶନ ପର୍ଯ୍ୟନ୍ତ, କର୍ମ ପ୍ରାଚୀନ ଜ୍ଞାନକୁ 100 ରୁ ଅଧିକ ଭାଷାରେ ଉପଲବ୍ଧ କରାଏ।';
  ...
  String get missionDescription =>
      'ଆମର ଲକ୍ଷ୍ୟ ସରଳ: ପ୍ରକୃତ, ମାନବ-ନେତୃତ୍ୱାଧୀନ ଜ୍ୟୋତିଷ ମାର୍ଗଦର୍ଶନ ପ୍ରଦାନ କରିବା ଯାହା ଆପଣଙ୍କୁ ଆତ୍ମବିଶ୍ୱାସୀ, ସୂଚନାଭିତ୍ତିକ ନିଷ୍ପତ୍ତି ନେବା ପାଇଁ ସଶକ୍ତ କରିଥାଏ। ପ୍ରତ୍ୟେକ ଭବିଷ୍ୟବାଣୀ ଏବଂ ପରାମର୍ଶ ସ୍ୱୟଂଚାଳିତ ଆଲଗୋରିଦମ ନୁହେଁ, ବରଂ ବର୍ଷ ବର୍ଷର ବୃତ୍ତିଗତ ବିଶେଷଜ୍ଞତାକୁ ପ୍ରତିଫଳିତ କରେ।';
  ...
  String get visionDescription =>
      'ଆମେ ବୈଦିକ ଜ୍ୟୋତିଷ ପାଇଁ ବିଶ୍ୱର ସବୁଠାରୁ ବିଶ୍ୱସ୍ତ ପ୍ଲାଟଫର୍ମ ହେବାକୁ ଚେଷ୍ଟା କରୁ, ଯାହା ସବୁଠି ଲୋକଙ୍କୁ ନିଜକୁ, ସେମାନଙ୍କ ପସନ୍ଦକୁ ଏବଂ ସେମାନଙ୍କ ଜୀବନ ଯାତ୍ରାକୁ ସ୍ପଷ୍ଟତା ଏବଂ ଆତ୍ମବିଶ୍ୱାସର ସହିତ ବୁଝିବାରେ ସାହାଯ୍ୟ କରେ।';
  ...
  String get valuesDescription =>
      'କର୍ମାରେ, ଆମେ ସତ୍ୟତା, ସଠିକତା ଏବଂ ବିଶ୍ୱାସକୁ ମୂଲ୍ୟ ଦେଉଛୁ। ଆମେ ଏପରି ମାର୍ଗଦର୍ଶନ ପ୍ରଦାନ କରିବାକୁ ପ୍ରତିବଦ୍ଧ ଯାହା କେବଳ ସଠିକ ନୁହେଁ ବରଂ ଅର୍ଥପୂର୍ଣ୍ଣ ମଧ୍ୟ, ଯାହା ଆପଣଙ୍କୁ ଅନ୍ତର୍ଦୃଷ୍ଟି ଏବଂ ଆତ୍ମବିଶ୍ୱାସ ସହିତ ଜୀବନକୁ ଆଗେଇ ନେବାରେ ସାହାଯ୍ୟ କରିବ।';

  @override
  String get contactUs => 'ଆମ ସହିତ ଯୋଗାଯୋଗ କରନ୍ତୁ';

  @override
  String get contactEmail => 'ଇମେଲ୍: care@karmalifepath.com';

  @override
  String get contactWebsite => 'ୱେବସାଇଟ୍: www.karmalifepath.com';
  ...
  String paymentRequiredMessage(Object amount) {
    return 'ଆପଣ ଆପଣଙ୍କର ମାଗଣା ପ୍ରଶ୍ନଗୁଡ଼ିକ ବ୍ୟବହାର କରିଛନ୍ତି। ଜାରି ରଖିବାକୁ $amount ଦେୟ ଦିଅନ୍ତୁ।';
  }
  ...
  String get teamDescription =>
      'ଆମର ବୃତ୍ତିଗତ ବୈଦିକ ଜ୍ୟୋତିଷ ଦଳ ଗ୍ରହ ପ୍ରଭାବ ଏବଂ ଜୀବନ ଧାରା ବ୍ୟାଖ୍ୟା କରିବାରେ ବର୍ଷ ବର୍ଷର ଅଭିଜ୍ଞତା ଆଣିଛନ୍ତି। ଏକ ଉତ୍ସର୍ଗୀକୃତ ସମର୍ଥନ ଏବଂ ବିକାଶ ଦଳ ଦ୍ୱାରା ସମର୍ଥିତ, କର୍ମା ପ୍ରତ୍ୟେକ ଉପଭୋକ୍ତାଙ୍କ ପାଇଁ ଏକ ସୁଗମ, ନିର୍ଭରଯୋଗ୍ୟ ଏବଂ ବିଶ୍ୱବ୍ୟାପୀ ଅଭିଜ୍ଞତା ପ୍ରଦାନ କରେ।';
}

...
class MaterialLocalizationsAf extends DefaultMaterialLocalizations {
  MaterialLocalizationsAf();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsAfDelegate();
}

class _MaterialLocalizationsAfDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsAfDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsAf();
  }

  @override
  bool shouldReload(_MaterialLocalizationsAfDelegate old) => false;
}

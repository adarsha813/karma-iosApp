...
class MaterialLocalizationsTg extends DefaultMaterialLocalizations {
  MaterialLocalizationsTg();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsTgDelegate();
}

class _MaterialLocalizationsTgDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsTg();
  }

...
class MaterialLocalizationsTa extends DefaultMaterialLocalizations {
  MaterialLocalizationsTa();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsTaDelegate();
}

class _MaterialLocalizationsTaDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsTaDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsTa();
  }

  @override
  bool shouldReload(_MaterialLocalizationsTaDelegate old) => false;
}

...
class CupertinoLocalizationsJv extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsJv();

  // TODO: Add translations for Javanese
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsJvDelegate();
}

class _CupertinoLocalizationsJvDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsJvDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsJv();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsJvDelegate old) => false;
}

...
class MaterialLocalizationsCy extends DefaultMaterialLocalizations {
  MaterialLocalizationsCy();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsCyDelegate();
}

class _MaterialLocalizationsCyDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsCyDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsCy();
  }

  @override
  bool shouldReload(_MaterialLocalizationsCyDelegate old) => false;
}

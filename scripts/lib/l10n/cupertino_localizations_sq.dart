...
class CupertinoLocalizationsSq extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsSq();

  // TODO: Add translations for Albanian
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsSqDelegate();
}

class _CupertinoLocalizationsSqDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsSqDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'sq';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsSq();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsSqDelegate old) => false;
}

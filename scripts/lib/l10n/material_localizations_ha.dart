...
class MaterialLocalizationsHa extends DefaultMaterialLocalizations {
  MaterialLocalizationsHa();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsHaDelegate();
}

class _MaterialLocalizationsHaDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsHaDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsHa();
  }

  @override
  bool shouldReload(_MaterialLocalizationsHaDelegate old) => false;
}

...
class MaterialLocalizationsBe extends DefaultMaterialLocalizations {
  MaterialLocalizationsBe();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsBeDelegate();
}

class _MaterialLocalizationsBeDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsBeDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsBe();
  }

  @override
  bool shouldReload(_MaterialLocalizationsBeDelegate old) => false;
}

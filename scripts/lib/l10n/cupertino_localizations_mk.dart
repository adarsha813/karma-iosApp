...
class CupertinoLocalizationsMk extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsMk();

  // TODO: Add translations for Macedonian
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsMkDelegate();
}

class _CupertinoLocalizationsMkDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsMkDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'mk';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsMk();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsMkDelegate old) => false;
}

...
class MaterialLocalizationsIg extends DefaultMaterialLocalizations {
  MaterialLocalizationsIg();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsIgDelegate();
}

class _MaterialLocalizationsIgDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsIgDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsIg();
  }

  @override
  bool shouldReload(_MaterialLocalizationsIgDelegate old) => false;
}

...
// Tatar
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsTtDelegate();
}

class _CupertinoLocalizationsTtDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsTtDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsTt();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsTtDelegate old) => false;
}

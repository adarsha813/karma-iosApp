...
class MaterialLocalizationsSk extends DefaultMaterialLocalizations {
  MaterialLocalizationsSk();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsSkDelegate();
}

class _MaterialLocalizationsSkDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsSkDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsSk();
  }

  @override
  bool shouldReload(_MaterialLocalizationsSkDelegate old) => false;
}

...
class MaterialLocalizationsEu extends DefaultMaterialLocalizations {
  MaterialLocalizationsEu();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsEuDelegate();
}

class _MaterialLocalizationsEuDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsEuDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsEu();
  }

  @override
  bool shouldReload(_MaterialLocalizationsEuDelegate old) => false;
}

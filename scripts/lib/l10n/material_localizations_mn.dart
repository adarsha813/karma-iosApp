...
class MaterialLocalizationsMn extends DefaultMaterialLocalizations {
  MaterialLocalizationsMn();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsMnDelegate();
}

class _MaterialLocalizationsMnDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsMnDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsMn();
  }

  @override
  bool shouldReload(_MaterialLocalizationsMnDelegate old) => false;
}

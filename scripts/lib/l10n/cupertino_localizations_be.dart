...
class CupertinoLocalizationsBe extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsBe();

  // TODO: Add translations for Belarusian
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsBeDelegate();
}

class _CupertinoLocalizationsBeDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsBeDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsBe();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsBeDelegate old) => false;
}

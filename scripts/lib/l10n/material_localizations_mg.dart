...
class MaterialLocalizationsMg extends DefaultMaterialLocalizations {
  MaterialLocalizationsMg();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsMgDelegate();
}

class _MaterialLocalizationsMgDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsMgDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsMg();
  }

  @override
  bool shouldReload(_MaterialLocalizationsMgDelegate old) => false;
}

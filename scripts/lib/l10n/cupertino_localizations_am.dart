...
class CupertinoLocalizationsAm extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsAm();

  // TODO: Add translations for Amharic
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsAmDelegate();
}

class _CupertinoLocalizationsAmDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsAmDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsAm();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsAmDelegate old) => false;
}

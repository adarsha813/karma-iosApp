...
class CupertinoLocalizationsMn extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsMn();

  // TODO: Add translations for Mongolian
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsMnDelegate();
}

class _CupertinoLocalizationsMnDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsMnDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsMn();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsMnDelegate old) => false;
}

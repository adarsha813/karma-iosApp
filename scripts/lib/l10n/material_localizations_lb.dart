...
class MaterialLocalizationsLb extends DefaultMaterialLocalizations {
  MaterialLocalizationsLb();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsLbDelegate();
}

class _MaterialLocalizationsLbDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsLbDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsLb();
  }

  @override
  bool shouldReload(_MaterialLocalizationsLbDelegate old) => false;
}

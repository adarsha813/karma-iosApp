...
class CupertinoLocalizationsUg extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsUg();

  // TODO: Add translations for Uyghur
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsUgDelegate();
}

class _CupertinoLocalizationsUgDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsUgDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsUg();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsUgDelegate old) => false;
}

...
class MaterialLocalizationsMy extends DefaultMaterialLocalizations {
  MaterialLocalizationsMy();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsMyDelegate();
}

class _MaterialLocalizationsMyDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsMyDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsMy();
  }

  @override
  bool shouldReload(_MaterialLocalizationsMyDelegate old) => false;
}

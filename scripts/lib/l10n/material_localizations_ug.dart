...
class MaterialLocalizationsUg extends DefaultMaterialLocalizations {
  MaterialLocalizationsUg();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsUgDelegate();
}

class _MaterialLocalizationsUgDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsUgDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsUg();
  }

  @override
  bool shouldReload(_MaterialLocalizationsUgDelegate old) => false;
}

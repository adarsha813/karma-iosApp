...
class MaterialLocalizationsSw extends DefaultMaterialLocalizations {
  MaterialLocalizationsSw();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsSwDelegate();
}

class _MaterialLocalizationsSwDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsSwDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsSw();
  }

  @override
  bool shouldReload(_MaterialLocalizationsSwDelegate old) => false;
}

...
class CupertinoLocalizationsTe extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsTe();

  // TODO: Add translations for Telugu
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsTeDelegate();
}

class _CupertinoLocalizationsTeDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsTeDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsTe();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsTeDelegate old) => false;
}

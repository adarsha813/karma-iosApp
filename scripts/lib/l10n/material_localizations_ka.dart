...
class MaterialLocalizationsKa extends DefaultMaterialLocalizations {
  MaterialLocalizationsKa();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsKaDelegate();
}

class _MaterialLocalizationsKaDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsKaDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsKa();
  }

  @override
  bool shouldReload(_MaterialLocalizationsKaDelegate old) => false;
}

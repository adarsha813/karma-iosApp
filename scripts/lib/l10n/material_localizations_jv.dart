...
class MaterialLocalizationsJv extends DefaultMaterialLocalizations {
  MaterialLocalizationsJv();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsJvDelegate();
}

class _MaterialLocalizationsJvDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsJvDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsJv();
  }

  @override
  bool shouldReload(_MaterialLocalizationsJvDelegate old) => false;
}

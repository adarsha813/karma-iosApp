...
class CupertinoLocalizationsCo extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsCo();

  // TODO: Add translations for Corsican
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsCoDelegate();
}

class _CupertinoLocalizationsCoDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsCoDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'co';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsCo();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsCoDelegate old) => false;
}

...
class CupertinoLocalizationsRw extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsRw();

  // TODO: Add translations for Kinyarwanda
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsRwDelegate();
}

class _CupertinoLocalizationsRwDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsRwDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsRw();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsRwDelegate old) => false;
}

...
class CupertinoLocalizationsEu extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsEu();

  // TODO: Add translations for Basque
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsEuDelegate();
}

class _CupertinoLocalizationsEuDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsEuDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'eu';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsEu();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsEuDelegate old) => false;
}

...
class MaterialLocalizationsAm extends DefaultMaterialLocalizations {
  MaterialLocalizationsAm();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsAmDelegate();
}

class _MaterialLocalizationsAmDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsAmDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsAm();
  }

  @override
  bool shouldReload(_MaterialLocalizationsAmDelegate old) => false;
}

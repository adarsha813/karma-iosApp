...
class MaterialLocalizationsSn extends DefaultMaterialLocalizations {
  MaterialLocalizationsSn();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsSnDelegate();
}

class _MaterialLocalizationsSnDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsSnDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsSn();
  }

  @override
  bool shouldReload(_MaterialLocalizationsSnDelegate old) => false;
}

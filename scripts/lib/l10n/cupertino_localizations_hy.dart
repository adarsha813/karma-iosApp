...
class CupertinoLocalizationsHy extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsHy();

  // TODO: Add translations for Armenian
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsHyDelegate();
}

class _CupertinoLocalizationsHyDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsHyDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'hy';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsHy();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsHyDelegate old) => false;
}

...
class CupertinoLocalizationsNy extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsNy();

  // TODO: Add translations for Nyanja (Chichewa)
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsNyDelegate();
}

class _CupertinoLocalizationsNyDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsNyDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsNy();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsNyDelegate old) => false;
}

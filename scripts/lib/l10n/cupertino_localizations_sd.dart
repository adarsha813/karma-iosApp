...
class CupertinoLocalizationsSd extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsSd();

  // TODO: Add translations for Sindhi
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsSdDelegate();
}

class _CupertinoLocalizationsSdDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsSdDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsSd();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsSdDelegate old) => false;
}

...
class MaterialLocalizationsSt extends DefaultMaterialLocalizations {
  MaterialLocalizationsSt();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsStDelegate();
}

class _MaterialLocalizationsStDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsStDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsSt();
  }

  @override
  bool shouldReload(_MaterialLocalizationsStDelegate old) => false;
}

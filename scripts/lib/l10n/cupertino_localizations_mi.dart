...
class CupertinoLocalizationsMi extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsMi();

  // TODO: Add translations for Maori
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsMiDelegate();
}

class _CupertinoLocalizationsMiDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsMiDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsMi();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsMiDelegate old) => false;
}

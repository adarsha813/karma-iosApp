...
class MaterialLocalizationsSm extends DefaultMaterialLocalizations {
  MaterialLocalizationsSm();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsSmDelegate();
}

class _MaterialLocalizationsSmDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsSmDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsSm();
  }

  @override
  bool shouldReload(_MaterialLocalizationsSmDelegate old) => false;
}

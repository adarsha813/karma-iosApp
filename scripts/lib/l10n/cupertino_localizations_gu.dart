...
class CupertinoLocalizationsGu extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsGu();

  // TODO: Add translations for Gujarati
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsGuDelegate();
}

class _CupertinoLocalizationsGuDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsGuDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'gu';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsGu();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsGuDelegate old) => false;
}

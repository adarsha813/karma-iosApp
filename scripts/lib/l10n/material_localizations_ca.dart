...
class MaterialLocalizationsCa extends DefaultMaterialLocalizations {
  MaterialLocalizationsCa();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsCaDelegate();
}

class _MaterialLocalizationsCaDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsCaDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsCa();
  }

  @override
  bool shouldReload(_MaterialLocalizationsCaDelegate old) => false;
}

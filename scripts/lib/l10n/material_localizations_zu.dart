...
class MaterialLocalizationsZu extends DefaultMaterialLocalizations {
  MaterialLocalizationsZu();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsZuDelegate();
}

class _MaterialLocalizationsZuDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsZuDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsZu();
  }

  @override
  bool shouldReload(_MaterialLocalizationsZuDelegate old) => false;
}

...
class CupertinoLocalizationsSv extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsSv();

  // TODO: Add translations for SV
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsSvDelegate();
}

class _CupertinoLocalizationsSvDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsSvDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsSv();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsSvDelegate old) => false;
}

...
class MaterialLocalizationsMt extends DefaultMaterialLocalizations {
  MaterialLocalizationsMt();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsMtDelegate();
}

class _MaterialLocalizationsMtDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsMtDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsMt();
  }

  @override
  bool shouldReload(_MaterialLocalizationsMtDelegate old) => false;
}

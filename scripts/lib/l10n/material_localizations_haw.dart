...
class MaterialLocalizationsHaw extends DefaultMaterialLocalizations {
  MaterialLocalizationsHaw();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsHawDelegate();
}

class _MaterialLocalizationsHawDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsHawDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsHaw();
  }

  @override
  bool shouldReload(_MaterialLocalizationsHawDelegate old) => false;
}

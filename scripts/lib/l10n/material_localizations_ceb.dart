...
class MaterialLocalizationsCeb extends DefaultMaterialLocalizations {
  MaterialLocalizationsCeb();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsCebDelegate();
}

class _MaterialLocalizationsCebDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsCebDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsCeb();
  }

  @override
  bool shouldReload(_MaterialLocalizationsCebDelegate old) => false;
}

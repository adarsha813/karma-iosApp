...
class CupertinoLocalizationsYi extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsYi();

  // TODO: Add translations for Yiddish
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsYiDelegate();
}

class _CupertinoLocalizationsYiDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsYiDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'yi';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsYi();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsYiDelegate old) => false;
}

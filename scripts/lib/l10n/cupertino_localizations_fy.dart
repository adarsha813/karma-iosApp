...
class CupertinoLocalizationsFy extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsFy();

  // TODO: Add translations for Frisian
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsFyDelegate();
}

class _CupertinoLocalizationsFyDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsFyDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'fy';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsFy();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsFyDelegate old) => false;
}

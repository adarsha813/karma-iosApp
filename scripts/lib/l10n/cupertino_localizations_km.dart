...
class CupertinoLocalizationsKm extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsKm();

  // TODO: Add translations for Khmer
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsKmDelegate();
}

class _CupertinoLocalizationsKmDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsKmDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'km';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsKm();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsKmDelegate old) => false;
}

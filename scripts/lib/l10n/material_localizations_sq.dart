...
class MaterialLocalizationsSq extends DefaultMaterialLocalizations {
  MaterialLocalizationsSq();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsSqDelegate();
}

class _MaterialLocalizationsSqDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsSqDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsSq();
  }

  @override
  bool shouldReload(_MaterialLocalizationsSqDelegate old) => false;
}

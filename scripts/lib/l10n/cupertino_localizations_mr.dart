...
class CupertinoLocalizationsMr extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsMr();

  // TODO: Add translations for Marathi
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsMrDelegate();
}

class _CupertinoLocalizationsMrDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsMrDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsMr();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsMrDelegate old) => false;
}

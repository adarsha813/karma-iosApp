...
class MaterialLocalizationsNy extends DefaultMaterialLocalizations {
  MaterialLocalizationsNy();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsNyDelegate();
}

class _MaterialLocalizationsNyDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsNyDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsNy();
  }

  @override
  bool shouldReload(_MaterialLocalizationsNyDelegate old) => false;
}

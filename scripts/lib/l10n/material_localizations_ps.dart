...
class MaterialLocalizationsPs extends DefaultMaterialLocalizations {
  MaterialLocalizationsPs();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsPsDelegate();
}

class _MaterialLocalizationsPsDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsPsDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsPs();
  }

  @override
  bool shouldReload(_MaterialLocalizationsPsDelegate old) => false;
}

...
class CupertinoLocalizationsHmn extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsHmn();

  // TODO: Add translations for Hmong
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsHmnDelegate();
}

class _CupertinoLocalizationsHmnDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsHmnDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'hmn';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsHmn();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsHmnDelegate old) => false;
}

...
class CupertinoLocalizationsKn extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsKn();

  // TODO: Add translations for Kannada
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsKnDelegate();
}

class _CupertinoLocalizationsKnDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsKnDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'kn';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsKn();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsKnDelegate old) => false;
}

...
class CupertinoLocalizationsCa extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsCa();

  // TODO: Add translations for Catalan
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsCaDelegate();
}

class _CupertinoLocalizationsCaDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsCaDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'ca';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsCa();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsCaDelegate old) => false;
}

...
class MaterialLocalizationsMs extends DefaultMaterialLocalizations {
  MaterialLocalizationsMs();

  // TODO: Add translations for Malay
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsMsDelegate();
}

class _MaterialLocalizationsMsDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsMsDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsMs();
  }

  @override
  bool shouldReload(_MaterialLocalizationsMsDelegate old) => false;
}

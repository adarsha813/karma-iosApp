...
class CupertinoLocalizationsSw extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsSw();

  // TODO: Add translations for Swahili
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsSwDelegate();
}

class _CupertinoLocalizationsSwDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsSwDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsSw();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsSwDelegate old) => false;
}

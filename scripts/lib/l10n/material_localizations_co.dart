...
class MaterialLocalizationsCo extends DefaultMaterialLocalizations {
  MaterialLocalizationsCo();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsCoDelegate();
}

class _MaterialLocalizationsCoDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsCoDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsCo();
  }

  @override
  bool shouldReload(_MaterialLocalizationsCoDelegate old) => false;
}

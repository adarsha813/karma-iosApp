...
class CupertinoLocalizationsTl extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsTl();

  // TODO: Add translations for Tagalog (Filipino)
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsTlDelegate();
}

class _CupertinoLocalizationsTlDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsTlDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsTl();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsTlDelegate old) => false;
}

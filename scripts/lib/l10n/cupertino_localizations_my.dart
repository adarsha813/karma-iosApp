...
class CupertinoLocalizationsMy extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsMy();

  // TODO: Add translations for Myanmar (Burmese)
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsMyDelegate();
}

class _CupertinoLocalizationsMyDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsMyDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'my';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsMy();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsMyDelegate old) => false;
}

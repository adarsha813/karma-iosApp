...
class CupertinoLocalizationsSu extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsSu();
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsSuDelegate();
}

class _CupertinoLocalizationsSuDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsSuDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsSu();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsSuDelegate old) => false;
}

...
class CupertinoLocalizationsSm extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsSm();

  // TODO: Add translations for Samoan
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsSmDelegate();
}

class _CupertinoLocalizationsSmDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsSmDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'sm';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsSm();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsSmDelegate old) => false;
}

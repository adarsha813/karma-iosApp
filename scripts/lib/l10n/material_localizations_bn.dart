...
class MaterialLocalizationsBn extends DefaultMaterialLocalizations {
  MaterialLocalizationsBn();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsBnDelegate();
}

class _MaterialLocalizationsBnDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsBnDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsBn();
  }

  @override
  bool shouldReload(_MaterialLocalizationsBnDelegate old) => false;
}

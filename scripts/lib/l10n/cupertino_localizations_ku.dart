...
class CupertinoLocalizationsKu extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsKu();

  // TODO: Add translations for Kurdish
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsKuDelegate();
}

class _CupertinoLocalizationsKuDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsKuDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsKu();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsKuDelegate old) => false;
}

...
class CupertinoLocalizationsBs extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsBs();

  // TODO: Add translations for Bosnian
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsBsDelegate();
}

class _CupertinoLocalizationsBsDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsBsDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'bs';

  @override
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsBs();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsBsDelegate old) => false;
}

...
class CupertinoLocalizationsMg extends DefaultCupertinoLocalizations {
  const CupertinoLocalizationsMg();

  // TODO: Add translations for Malagasy
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate = _CupertinoLocalizationsMgDelegate();
}

class _CupertinoLocalizationsMgDelegate extends LocalizationsDelegate<CupertinoLocalizations> {
  const _CupertinoLocalizationsMgDelegate();
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    return const CupertinoLocalizationsMg();
  }

  @override
  bool shouldReload(_CupertinoLocalizationsMgDelegate old) => false;
}

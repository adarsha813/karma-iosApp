...
class MaterialLocalizationsSd extends DefaultMaterialLocalizations {
  MaterialLocalizationsSd();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsSdDelegate();
}

class _MaterialLocalizationsSdDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsSdDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsSd();
  }

  @override
  bool shouldReload(_MaterialLocalizationsSdDelegate old) => false;
}

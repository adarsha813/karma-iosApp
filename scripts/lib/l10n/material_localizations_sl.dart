...
class MaterialLocalizationsSl extends DefaultMaterialLocalizations {
  MaterialLocalizationsSl();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _MaterialLocalizationsSlDelegate();
}

class _MaterialLocalizationsSlDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsSlDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'sl';

  @override
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsSl();
  }

  @override
  bool shouldReload(_MaterialLocalizationsSlDelegate old) => false;
}

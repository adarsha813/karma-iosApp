...
class MaterialLocalizationsFy extends DefaultMaterialLocalizations {
  MaterialLocalizationsFy();
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate =
      _MaterialLocalizationsFyDelegate();
}

class _MaterialLocalizationsFyDelegate
    extends LocalizationsDelegate<MaterialLocalizations> {
  const _MaterialLocalizationsFyDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return MaterialLocalizationsFy();
  }

  @override
  bool shouldReload(_MaterialLocalizationsFyDelegate old) => false;
}
